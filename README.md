...
- 📜 [Original MCP Specification](https://modelcontextprotocol.io/specification/2025-11-25) – This contains additional technical details that can be helpful for advanced implementations. It's there when you need it, but don't worry about it when you're starting out.
