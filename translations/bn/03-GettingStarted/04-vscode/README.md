...
![Visual Studio Code-এ গাইডেড MCP সার্ভার কনফিগারেশন](../../../../translated_images/bn/chat-mode-agent.729a22473f822216dd1e723aaee1f7d4a2ede571ee0948037a2d9357a63b9d0b.png)  
![এজেন্ট সেশনের জন্য টুল নির্বাচন](../../../../translated_images/bn/agent-mode-select-tools.522c7ba5df0848f8f0d1e439c2e96159431bc620cb39ccf3f5dc611412fd0006.png)  
![MCP ডেভেলপমেন্ট চলাকালীন সহজে ত্রুটি ডিবাগ করুন](../../../../translated_images/bn/mcp-list-servers.fce89eefe3f30032bed8952e110ab9d82fadf043fcfa071f7d40cf93fb1ea9e9.png)  
...
1. *mcp.json* ফাইলে আপনার এন্ট্রি খুঁজুন এবং নিশ্চিত করুন যে আপনি "প্লে" আইকনটি দেখতে পাচ্ছেন:
  ...
  ![Visual Studio Code-এ সার্ভার শুরু করা](../../../../translated_images/bn/vscode-start-server.8e3c986612e3555de47e5b1e37b2f3020457eeb6a206568570fd74a17e3796ad.png)  
...
1. "প্লে" আইকনে ক্লিক করুন। আপনি দেখবেন GitHub Copilot Chat-এর টুলস আইকনে উপলব্ধ টুলের সংখ্যা বৃদ্ধি পেয়েছে। উক্ত টুলস আইকনে ক্লিক করলে, আপনি নিবন্ধিত টুলগুলোর একটি তালিকা দেখতে পাবেন। আপনি চাইলে প্রতিটি টুল চেক/আনচেক করতে পারেন যাতে GitHub Copilot সেগুলো প্রসঙ্গ হিসেবে ব্যবহার করে:
  ...
  ![Visual Studio Code-এ টুলস ব্যবহার করা](../../../../translated_images/bn/vscode-tool.0b3bbea2fb7d8c26ddf573cad15ef654e55302a323267d8ee6bd742fe7df7fed.png)
...
1. একটি টুল চালানোর জন্য, এমন একটি প্রম্পট টাইপ করুন যা আপনার টুলগুলোর বর্ণনার সাথে মেলে, উদাহরণস্বরূপ, "add 22 to 1" এর মতো একটি প্রম্পট:
  ...
  ![GitHub Copilot থেকে একটি টুল চালানো](../../../../translated_images/bn/vscode-agent.d5a0e0b897331060518fe3f13907677ef52b879db98c64d68a38338608f3751e.png)
