...
1. **Add the MCP configuration:**  
   ...
   ![Step 1: Add mcp.json to .vscode folder](../../../../../../translated_images/en/step1-mcp-json.c06a007fccc3edfa.png)
...
2. **Open the GitHub Copilot Chat panel:**  
   ...
   ![Step 2: Open Copilot Chat panel](../../../../../../translated_images/en/step2-copilot-panel.f1cc86e9b9b8cd1a.png)

3. **Enable agent mode and verify tools:**  
   In the Copilot Chat panel, enable agent mode.

   ![Step 3: Enable agent mode and verify tools](../../../../../../translated_images/en/step3-agent-mode.cdc32520fd7dd1d1.png)
   ...
   ![Step 3: Verify MCP server tool](../../../../../../translated_images/en/step3-verify-mcp-tool.76096a6329cbfecd.png)
...
4. **Start a new chat and prompt the agent:**  
   ...
   ![Step 4: Prompt the agent in chat](../../../../../../translated_images/en/step4-prompt-chat.12187bb001605efc.png)
...
5. **Live Query:**
   ...
   *"I’m looking for answers on how to deploy a multi-agent solution with AI agents developed on Azure AI Foundry. I see there’s no direct deployment method like Copilot Studio channels. So, what are the different ways to deploy this so enterprise users can interact and get the job done?  
   ...
   ![Step 5: Live queries](../../../../../../translated_images/en/step5-live-queries.49db3e4a50bea273.png)
