...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-18T19:01:34+00:00",
...
- 📘 [وثائق MCP](https://modelcontextprotocol.io/) – هذا هو موردك الأساسي للدروس الإرشادية خطوة بخطوة وأدلة المستخدم. الوثائق مكتوبة مع وضع المبتدئين في الاعتبار، وتوفر أمثلة واضحة يمكنك متابعتها بوتيرتك الخاصة.
...
- 📜 [المواصفات الأصلية لـ MCP](https://modelcontextprotocol.io/specification/versioning) – تحتوي على تفاصيل تقنية إضافية يمكن أن تكون مفيدة للتطبيقات المتقدمة. هي موجودة عندما تحتاجها، لكن لا تقلق بشأنها عند البدء.
...
• **فهم أساسيات MCP**: ستدرك ما هو بروتوكول سياق النموذج ولماذا يحدث ثورة في كيفية تعاون تطبيقات الذكاء الاصطناعي، باستخدام تشبيهات وأمثلة واضحة.
...
فكر في البروتوكول كقواعد للمحادثة. عندما تتصل بصديق، تعرفان أن تقول "مرحبًا" عند الرد، وتأخذان دور الكلام، وتقولان "وداعًا" عند الانتهاء. تحتاج برامج الكمبيوتر إلى قواعد مماثلة للتواصل بفعالية.
...
يوفر MCP هذا التوحيد القياسي لتطبيقات الذكاء الاصطناعي. بدلاً من أن يحتاج كل نموذج ذكاء اصطناعي إلى شيفرة مخصصة للعمل مع كل أداة، يخلق MCP طريقة عالمية للتواصل. هذا يعني أن المطورين يمكنهم بناء الأدوات مرة واحدة وجعلها تعمل مع العديد من أنظمة الذكاء الاصطناعي المختلفة.
...
| 11.9 | الاختبار والتصحيح | استراتيجيات الاختبار، أدوات التصحيح، ونهج التحقق | [المختبر 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
...
دليل دراسة شامل [Study Guide](./study_guide.md) متاح لمساعدتك على التنقل في هذا المستودع بفعالية. تُظهر خريطة المنهج المرئية كيف ترتبط جميع المواضيع وتوفر إرشادات حول كيفية استخدام المشاريع النموذجية بفعالية. هذا مفيد بشكل خاص إذا كنت متعلمًا بصريًا يحب رؤية الصورة الكبيرة.
...
يركز بالكامل على تمكين المطورين من استخدام MCP في سير عملهم التطويري والاحتفال بمجتمع MCP الرائع. سينضم إلينا أعضاء المجتمع وشركاء مثل Arcade وBlock وOkta وNeon لنرى كيف يتعاونون مع مايكروسوفت لتشكيل نظام بيئي مفتوح وقابل للتوسيع لـ MCP. عروض حية من العالم الحقيقي عبر VS Code وVisual Studio وGitHub Copilot وأدوات المجتمع الشهيرة
...
لنتعرف على بروتوكول سياق النموذج (MCP)، وهو إطار عمل متقدم مصمم لتوحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العميل. من خلال هذه الجلسة الموجهة للمبتدئين، سنقدم لك MCP ونرشدك خلال إنشاء أول خادم MCP خاص بك.
...
أثناء تقدمك في الوحدات، تذكر أن كل خبير كان مبتدئًا في يوم من الأيام. المفاهيم التي قد تبدو معقدة الآن ستصبح طبيعية مع الممارسة والتطبيق. كل خطوة صغيرة تبني نحو قدرات قوية ستخدمك طوال مسيرتك التطويرية.
...
ينمو هذا المنهج بقوة بمساهمات المتعلمين مثلك! سواء كنت تصلح خطأ مطبعي، أو تقترح شرحًا أوضح، أو تضيف مثالًا جديدًا، فإن مساهماتك تساعد المبتدئين الآخرين على النجاح.

شكر خاص للمحترف المعتمد من مايكروسوفت [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) لمساهمته في عينات الشيفرة.

تم تصميم عملية المساهمة لتكون مرحبة وداعمة. تتطلب معظم المساهمات اتفاقية ترخيص المساهم (CLA)، لكن الأدوات الآلية سترشدك خلال العملية بسلاسة.
...
اتفاقية ترخيص المساهم (CLA) التي تعلن فيها أنك تملك الحق، وأنك تمنحنا
...
*هل أنت مستعد لبدء رحلتك مع MCP؟ ابدأ بـ [الوحدة 00 - مقدمة إلى MCP](./00-Introduction/README.md) وخطُو أولى خطواتك في عالم تطوير بروتوكول سياق النموذج!*
