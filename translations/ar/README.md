...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T16:30:39+00:00",
...
فكر في MCP كأنه مترجم عالمي لتطبيقات الذكاء الاصطناعي - تمامًا مثلما تسمح منافذ USB بتوصيل أي جهاز بجهاز الكمبيوتر الخاص بك، يسمح MCP لنماذج الذكاء الاصطناعي بالاتصال بأي أداة أو خدمة بطريقة موحدة. سواء كنت تبني أول روبوت محادثة لك أو تعمل على تدفقات عمل ذكاء اصطناعي معقدة، فإن فهم MCP سيمنحك القدرة على إنشاء تطبيقات أكثر قدرة ومرونة.
...
بحلول الوقت الذي تنهي فيه هذه الرحلة، ستكون لديك الثقة لبناء خوادم MCP الخاصة بك، دمجها مع منصات الذكاء الاصطناعي الشهيرة، وفهم كيف تعيد هذه التقنية تشكيل مستقبل تطوير الذكاء الاصطناعي. لنبدأ هذه المغامرة المثيرة معًا!

### الوثائق الرسمية والمواصفات

تصبح هذه الموارد أكثر قيمة مع نمو فهمك، لكن لا تشعر بالضغط لقراءتها كلها فورًا. ابدأ بالمجالات التي تثير اهتمامك أكثر!  
- 📘 [وثائق MCP](https://modelcontextprotocol.io/) – هذا هو المورد الأساسي الخاص بك للحصول على دروس إرشادية خطوة بخطوة ودلائل المستخدم. الوثائق مكتوبة مع مراعاة المبتدئين، وتوفر أمثلة واضحة يمكنك اتباعها وفقًا لسرعتك.  
- 📜 [مواصفات MCP](https://modelcontextprotocol.io/docs/) – فكر في هذا كدليل مرجعي شامل. أثناء تقدمك في المنهج، ستجد نفسك تعود إلى هنا للبحث عن تفاصيل محددة واستكشاف الميزات المتقدمة.  
...
• **فهم أساسيات MCP**: ستفهم ما هو بروتوكول سياق النموذج ولماذا يغير طريقة عمل تطبيقات الذكاء الاصطناعي معًا، باستخدام تشبيهات وأمثلة تجعل الأمور واضحة.  
...
فكر في البروتوكول كأنه قواعد للمحادثة. عندما تتصل بصديق، تعرف كلاكما أن تقول "مرحبًا" عند الرد، تأخذان دوركما في الحديث، وتقولان "وداعًا" عند الانتهاء. تحتاج البرامج إلى قواعد مشابهة للتواصل بشكل فعال.
...
أنت بالفعل تستخدم علاقات العميل والخادم كل يوم! عندما تستخدم متصفح ويب (العميل) لزيارة موقع ويب، فإنك تتصل بخادم ويب يرسل لك محتوى الصفحة. يعرف المتصفح كيفية طلب المعلومات، ويعرف الخادم كيفية الرد.

في MCP، لدينا علاقة مشابهة: تعمل نماذج الذكاء الاصطناعي كعملاء يطلبون معلومات أو إجراءات، بينما توفر خوادم MCP تلك القدرات. إنه مثل وجود مساعد مفيد (الخادم) يمكن للنموذج أن يطلب منه أداء مهام محددة.

### لماذا يهم التوحيد القياسي (جعل الأشياء تعمل معًا)

تخيل لو أن كل مصنع سيارات استخدم أشكالًا مختلفة لمضخات الوقود - ستحتاج إلى محول مختلف لكل سيارة! يعني التوحيد القياسي الاتفاق على نهج مشترك بحيث تعمل الأشياء معًا بسلاسة.

يوفر MCP هذا التوحيد القياسي لتطبيقات الذكاء الاصطناعي. بدلًا من أن يحتاج كل نموذج ذكاء اصطناعي إلى كود مخصص للعمل مع كل أداة، يخلق MCP طريقة عالمية للتواصل. هذا يعني أن المطورين يمكنهم بناء أدوات مرة واحدة وجعلها تعمل مع العديد من أنظمة الذكاء الاصطناعي المختلفة.
...
• **الوحدة 2 - الأمان في MCP**: قد يبدو الأمان مخيفًا، لكننا سنوضح لك كيف يتضمن MCP ميزات أمان مدمجة ونعلمك أفضل الممارسات التي تحمي تطبيقاتك من البداية.

### 🔨 مرحلة البناء: إنشاء أول تطبيقاتك (الوحدة 3)

الآن تبدأ المتعة الحقيقية! ستحصل على تجربة عملية لبناء خوادم وعملاء MCP فعلية. لا تقلق - سنبدأ ببساطة ونرشدك خلال كل خطوة.
...
كل دليل يتضمن أمثلة كود كاملة، نصائح لحل المشكلات، وتفسيرات حول سبب اتخاذنا خيارات تصميم محددة. بحلول نهاية هذه المرحلة، سيكون لديك تطبيقات MCP تعمل يمكنك أن تفخر بها!
...
المرحلة الأخيرة تركز على الانضمام إلى مجتمع MCP والتخصص في المجالات التي تهمك أكثر. ستتعلم كيفية المساهمة في مشاريع MCP مفتوحة المصدر، تنفيذ أنماط المصادقة المتقدمة، وبناء حلول شاملة متكاملة مع قواعد البيانات.

يستحق الوحدة 11 ذكرًا خاصًا - إنها مسار تعلم عملي يتضمن 13 مختبرًا يعلمك كيفية بناء خوادم MCP جاهزة للإنتاج مع تكامل PostgreSQL. إنه مثل مشروع التخرج الذي يجمع كل ما تعلمته!
...
| 3.10 | استخدام الخادم المتقدم | استخدام الخوادم المتقدمة لميزات متقدمة وتحسين الهيكلية | [الدليل](./03-GettingStarted/10-advanced/README.md) |
...
| 11 | تكامل قاعدة بيانات خادم MCP | مسار تعلم عملي شامل يتضمن 13 مختبرًا لتكامل PostgreSQL | [المختبرات](./11-MCPServerHandsOnLabs/README.md) |
...
- مسارات تعلم موصى بها لمستويات المهارات المختلفة
- موارد إضافية لتكملة رحلة التعلم الخاصة بك

### سجل التغييرات

نحافظ على [سجل تغييرات مفصل](./changelog.md) يتتبع جميع التحديثات المهمة لمواد المنهج، حتى تتمكن من البقاء على اطلاع بأحدث التحسينات والإضافات.
- إضافات محتوى جديدة
- تغييرات هيكلية
- تحسينات الميزات
- تحديثات الوثائق
...
#### [➡️شاهد حسب الطلب - أيام مطوري MCP](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
يهدف إلى تمكين المطورين من استخدام MCP في سير عملهم كمطورين والاحتفال بالمجتمع الرائع لـ MCP. سنكون برفقة أعضاء المجتمع وشركاء مثل Arcade، Block، Okta، وNeon لنرى كيف يتعاونون مع Microsoft لتشكيل نظام MCP مفتوح وقابل للتوسيع.  
...
سواء كنت قد بدأت للتو مع MCP أو كنت بالفعل تعمل بها، فإن اليوم الأول سيضع الأساس للإلهام والنصائح العملية.
...
#### [➡️ شاهد عند الطلب معسكر MCP التدريبي | الإنجليزية](https://developer.microsoft.com/en-us/reactor/series/s-1568/)  
#### [➡️ شاهد عند الطلب معسكر MCP التدريبي | البرتغالية](https://developer.microsoft.com/en-us/reactor/series/S-1566/)  
#### [➡️ شاهد عند الطلب معسكر MCP التدريبي | الإسبانية](https://developer.microsoft.com/en-us/reactor/series/S-1567/)  

### لنتعلم MCP مع C# - سلسلة تعليمية  
لنتعلم عن بروتوكول سياق النموذج (MCP)، وهو إطار عمل متقدم مصمم لتوحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العملاء. من خلال هذه الجلسة المناسبة للمبتدئين، سنقدم لك MCP ونرشدك لإنشاء أول خادم MCP خاص بك.  
...
من خلال قراءة هذا المقدمة، بدأت بالفعل في بناء أساس معرفتك بـ MCP. أنت تفهم ما هو MCP، لماذا هو مهم، وكيف سيدعم هذا المنهج رحلة تعلمك. هذا إنجاز كبير وبداية لتخصصك في هذه التقنية المهمة.
...
أنت تنضم إلى مجتمع من المتعلمين والخبراء الذين يهتمون بـ MCP ويتحمسون لمساعدة الآخرين على النجاح. سواء كنت تواجه تحديًا في البرمجة أو متحمسًا لمشاركة إنجاز، فإن المجتمع هنا لدعم رحلتك.
