...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T17:12:15+00:00",
...
Predstavte si MCP ako univerzálny prekladač pre aplikácie AI - podobne ako USB porty umožňujú pripojiť akékoľvek zariadenie k vášmu počítaču, MCP umožňuje modelom AI pripojiť sa k akémukoľvek nástroju alebo službe štandardizovaným spôsobom. Či už vytvárate svoj prvý chatbot alebo pracujete na zložitých AI pracovných postupoch, pochopenie MCP vám poskytne silu vytvárať schopnejšie a flexibilnejšie aplikácie.

Tento učebný plán je navrhnutý s ohľadom na trpezlivosť a starostlivosť o váš proces učenia. Začneme jednoduchými konceptmi, ktoré už poznáte, a postupne budeme rozvíjať vaše znalosti prostredníctvom praktických cvičení vo vašom obľúbenom programovacom jazyku. Každý krok obsahuje jasné vysvetlenia, praktické príklady a množstvo povzbudenia na ceste.
...
Tieto zdroje sa stanú hodnotnejšími, keď sa vaše porozumenie bude prehlbovať, ale necíťte sa pod tlakom, že musíte všetko prečítať hneď. Začnite s oblasťami, ktoré vás najviac zaujímajú!  
- 📘 [Dokumentácia MCP](https://modelcontextprotocol.io/) – Toto je váš hlavný zdroj pre podrobné návody a používateľské príručky. Dokumentácia je napísaná s ohľadom na začiatočníkov a poskytuje jasné príklady, ktoré môžete sledovať vlastným tempom.  
- 📜 [Špecifikácia MCP](https://modelcontextprotocol.io/docs/) – Považujte to za váš komplexný referenčný manuál. Ako budete prechádzať učebným plánom, budete sa sem vracať, aby ste si vyhľadali konkrétne detaily a preskúmali pokročilé funkcie.  
- 📜 [Pôvodná špecifikácia MCP](https://spec.modelcontextprotocol.io/) – Obsahuje ďalšie technické detaily, ktoré môžu byť užitočné pre pokročilé implementácie. Je tu, keď ju budete potrebovať, ale na začiatku sa tým netrápte.  
- 🧑‍💻 [Repozitár MCP na GitHub](https://github.com/modelcontextprotocol) – Tu nájdete SDK, nástroje a ukážky kódu v rôznych programovacích jazykoch. Je to ako pokladnica praktických príkladov a pripravených komponentov.  
- 🌐 [Komunita MCP](https://github.com/orgs/modelcontextprotocol/discussions) – Pripojte sa k ostatným študentom a skúseným vývojárom v diskusiách o MCP. Je to podporná komunita, kde sú otázky vítané a znalosti sa voľne zdieľajú.

## Ciele učenia

Na konci tohto učebného plánu sa budete cítiť sebavedomo a nadšene zo svojich nových schopností. Tu je, čo dosiahnete:

• **Pochopíte základy MCP**: Získate predstavu o tom, čo je Model Context Protocol a prečo revolučne mení spôsob, akým AI aplikácie spolupracujú, pomocou analógií a príkladov, ktoré dávajú zmysel.

• **Vytvoríte svoj prvý MCP server**: Vytvoríte funkčný MCP server vo vašom preferovanom programovacom jazyku, začínajúc jednoduchými príkladmi a postupne rozvíjajúc svoje zručnosti krok za krokom.

• **Prepojíte AI modely so skutočnými nástrojmi**: Naučíte sa, ako preklenúť medzeru medzi AI modelmi a skutočnými službami, čím poskytnete svojim aplikáciám nové schopnosti.

• **Implementujete najlepšie bezpečnostné postupy**: Pochopíte, ako udržať vaše MCP implementácie bezpečné, chrániac tak vaše aplikácie aj používateľov.

• **Nasadíte s istotou**: Budete vedieť, ako preniesť vaše MCP projekty z vývoja do produkcie, s praktickými stratégiami nasadenia, ktoré fungujú v reálnom svete.

• **Pripojíte sa ku komunite MCP**: Stanete sa súčasťou rastúcej komunity vývojárov, ktorí formujú budúcnosť vývoja AI aplikácií.

## Základné znalosti

Predtým, než sa pustíme do špecifík MCP, uistime sa, že sa cítite pohodlne s niektorými základnými konceptmi. Nebojte sa, ak nie ste odborníkom v týchto oblastiach - všetko, čo potrebujete vedieť, vám vysvetlíme postupne!

### Pochopenie protokolov (Základ)

Predstavte si protokol ako pravidlá pre konverzáciu. Keď zavoláte priateľovi, obaja viete, že máte povedať "ahoj" pri odpovedi, striedať sa v rozprávaní a povedať "dovidenia", keď skončíte. Počítačové programy potrebujú podobné pravidlá na efektívnu komunikáciu.

MCP je protokol - súbor dohodnutých pravidiel, ktoré pomáhajú AI modelom a aplikáciám viesť produktívne "konverzácie" s nástrojmi a službami. Rovnako ako pravidlá konverzácie zlepšujú ľudskú komunikáciu, MCP zlepšuje komunikáciu AI aplikácií.
...
Predstavte si, že každý výrobca áut používa inak tvarované čerpadlá na benzín - potrebovali by ste iný adaptér pre každé auto! Štandardizácia znamená dohodu na spoločných prístupoch, aby veci spolupracovali bez problémov.
...
Vaša cesta MCP je starostlivo štruktúrovaná tak, aby postupne budovala vašu sebadôveru a zručnosti. Každá fáza predstavuje nové koncepty a zároveň posilňuje to, čo ste už naučili.
...
• **Modul 0 - Úvod do MCP**: Začneme skúmaním, čo je MCP a prečo je tak dôležitý pre moderné AI aplikácie. Uvidíte príklady MCP v praxi a pochopíte, ako rieši bežné problémy, ktorým čelia vývojári.

• **Modul 1 - Vysvetlenie základných konceptov**: Tu sa naučíte základné stavebné bloky MCP. Použijeme množstvo analógií a vizuálnych príkladov, aby tieto koncepty boli prirodzené a pochopiteľné.

• **Modul 2 - Bezpečnosť v MCP**: Bezpečnosť môže znieť zastrašujúco, ale ukážeme vám, ako MCP obsahuje zabudované bezpečnostné prvky a naučíme vás najlepšie postupy, ktoré chránia vaše aplikácie od začiatku.
...
Tento modul obsahuje viacero praktických návodov, ktoré vám umožnia cvičiť vo vašom preferovanom programovacom jazyku. Vytvoríte svoj prvý server, postavíte klienta na pripojenie k nemu a dokonca integrujete s populárnymi vývojovými nástrojmi ako VS Code.
...
S osvojenými základmi ste pripravení preskúmať sofistikovanejšie funkcie MCP. Pokryjeme praktické implementačné stratégie, techniky ladenia a pokročilé témy ako integrácia multimodálnych AI.
...
Modul 11 si zaslúži zvláštnu pozornosť - ide o kompletnú praktickú cestu pozostávajúcu z 13 laboratórií, ktorá vás naučí, ako vytvárať produkčne pripravené MCP servery s integráciou PostgreSQL. Je to ako záverečný projekt, ktorý spája všetko, čo ste sa naučili!
...
|-------|------|-------|-------|
| **Moduly 1-3: Základy** | | | |
| 00 | Úvod do MCP | Prehľad Model Context Protocolu a jeho významu v AI pipeline | [Čítajte viac](./00-Introduction/README.md) |
...
| 3.10 | Pokročilé používanie servera | Používanie pokročilých serverov pre pokročilé funkcie a zlepšenú architektúru | [Návod](./03-GettingStarted/10-advanced/README.md) |
...
| 5.9 | Webové vyhľadávanie | Implementácia funkcií webového vyhľadávania | [Návod](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | Realtime Streaming | Vytváranie funkcií pre realtime streaming | [Návod](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 5.11 | Realtime Search | Implementácia realtime vyhľadávania | [Návod](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
...
| 07 | Postrehy z raného prijatia | Skutočné príbehy implementácie | [Návod](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | Najlepšie postupy pre MCP | Výkon, odolnosť voči chybám, odolnosť | [Návod](./08-BestPractices/README.md) |
| 09 | Prípadové štúdie MCP | Príklady praktickej implementácie | [Návod](./09-CaseStudy/README.md) |
...
| 11.1 | Úvod | Prehľad MCP s integráciou databázy a prípadová štúdia maloobchodnej analýzy | [Laboratórium 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | Bezpečnosť a multi-tenancy | Row Level Security, autentifikácia a prístup k dátam pre viacerých nájomcov | [Laboratórium 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Návrh databázy | Nastavenie PostgreSQL, návrh maloobchodnej schémy a vzorové dáta | [Laboratórium 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | Implementácia MCP servera | Vytvorenie servera FastMCP s integráciou databázy | [Laboratórium 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
Pripravte sa na dva dni hlbokých technických poznatkov, spojenia s komunitou a praktického učenia na MCP Dev Days, virtuálnom podujatí venovanom Model Context Protocol (MCP) — vznikajúcemu štandardu, ktorý spája AI modely a nástroje, na ktoré sa spoliehajú.
...
Sedenia vedené komunitou a cenné poznatky  
Či už s MCP len začínate, alebo už s ním pracujete, Deň 1 vám poskytne inšpiráciu a praktické tipy.
...
Naučme sa o Model Context Protocol (MCP), špičkovom rámci navrhnutom na štandardizáciu interakcií medzi AI modelmi a klientskými aplikáciami. Prostredníctvom tejto relácie pre začiatočníkov vám predstavíme MCP a prevedieme vás procesom vytvorenia vášho prvého MCP servera.  
...
Gratulujeme! Práve ste urobili prvý krok na vzrušujúcej ceste, ktorá rozšíri vaše programovacie schopnosti a priblíži vás k špičke AI vývoja.
...
Ako budete postupovať cez moduly, pamätajte, že každý expert bol kedysi začiatočníkom. Koncepty, ktoré sa vám teraz môžu zdať zložité, sa stanú samozrejmosťou, keď ich budete praktizovať a aplikovať. Každý malý krok vedie k silným schopnostiam, ktoré vám budú slúžiť počas celej vašej vývojárskej kariéry.

### Vaša podporná sieť  

Pridávate sa do komunity študentov a expertov, ktorí sú nadšení pre MCP a túžia pomáhať ostatným uspieť. Či už ste uviazli na programovacej výzve, alebo chcete zdieľať svoj pokrok, komunita je tu, aby podporila vašu cestu.

Ak sa zaseknete alebo máte akékoľvek otázky o budovaní AI aplikácií, pripojte sa k diskusiám o MCP s ostatnými študentmi a skúsenými vývojármi. Je to podporná komunita, kde sú otázky vítané a znalosti sa voľne zdieľajú.
...
Vaše MCP dobrodružstvo začína teraz! Začnite s Modulom 0, aby ste sa ponorili do svojich prvých praktických skúseností s MCP, alebo preskúmajte ukážkové projekty, aby ste videli, čo budete vytvárať. Pamätajte - každý expert začínal presne tam, kde ste teraz vy, a s trpezlivosťou a praxou budete ohromení tým, čo môžete dosiahnuť.
...
Ďakujeme Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za príspevky kódových ukážok.

Proces prispievania je navrhnutý tak, aby bol priateľský a podporujúci. Väčšina príspevkov vyžaduje Licenčnú zmluvu prispievateľa (CLA), ale automatizované nástroje vás týmto procesom hladko prevedú.

## 📜 Otvorené vzdelávanie  

Celý tento kurz je dostupný pod MIT [LICENSE](../../LICENSE), čo znamená, že ho môžete voľne používať, upravovať a zdieľať. To podporuje našu misiu sprístupniť znalosti o MCP vývojárom na celom svete.  
...
Keď odošlete pull request, CLA bot automaticky určí, či musíte poskytnúť CLA, a príslušne označí PR (napr. kontrola stavu, komentár). Jednoducho postupujte podľa pokynov poskytnutých botom. Toto budete musieť urobiť iba raz vo všetkých repozitároch, ktoré používajú našu CLA.
