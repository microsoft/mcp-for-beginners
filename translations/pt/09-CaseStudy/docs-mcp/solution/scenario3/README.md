...
1. **Adicione a configuração MCP:**
   ...
   ![Passo 1: Adicionar mcp.json à pasta .vscode](../../../../../../translated_images/pt/step1-mcp-json.c06a007fccc3edfaf0598a31903c9ec71476d9fd3ae6c1b2b4321fd38688ca4b.png)
...
2. **Abra o painel GitHub Copilot Chat:**
   ...
   ![Passo 2: Abrir painel Copilot Chat](../../../../../../translated_images/pt/step2-copilot-panel.f1cc86e9b9b8cd1a85e4df4923de8bafee4830541ab255e3c90c09777fed97db.png)

3. **Ative o modo agente e verifique as ferramentas:**
   No painel Copilot Chat, ative o modo agente.

   ![Passo 3: Ativar modo agente e verificar ferramentas](../../../../../../translated_images/pt/step3-agent-mode.cdc32520fd7dd1d149c3f5226763c1d85a06d3c041d4cc983447625bdbeff4d4.png)
   ...
   ![Passo 3: Verificar ferramenta do servidor MCP](../../../../../../translated_images/pt/step3-verify-mcp-tool.76096a6329cbfecd42888780f322370a0d8c8fa003ed3eeb7ccd23f0fc50c1ad.png)
4. **Inicie uma nova conversa e faça perguntas ao agente:**
   ...
   ![Passo 4: Fazer perguntas ao agente no chat](../../../../../../translated_images/pt/step4-prompt-chat.12187bb001605efc5077992b621f0fcd1df12023c5dce0464f8eb8f3d595218f.png)
...
Existem vários artigos/blogs que dizem que podemos usar o serviço Azure Bot para fazer este trabalho, que pode atuar como uma ponte entre o MS Teams e os Agentes do Azure AI Foundry. Será que isto funciona se configurar um bot Azure que se ligue ao Orchestrator Agent no Azure AI Foundry via Azure Function para realizar a orquestração, ou preciso criar uma Azure Function para cada um dos agentes de IA que fazem parte da solução multi-agente para fazer a orquestração no Bot Framework? Qualquer outra sugestão é muito bem-vinda."*
   ...
   ![Passo 5: Consultas em tempo real](../../../../../../translated_images/pt/step5-live-queries.49db3e4a50bea27327e3cb18c24d263b7d134930d78e7392f9515a1c00264a7f.png)
