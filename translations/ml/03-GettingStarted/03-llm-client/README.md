...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T19:21:52+00:00",
...
നമുക്ക് എടുക്കേണ്ട സമീപനം മനസ്സിലാക്കാം. LLM ചേർക്കുന്നത് ലളിതമാണ് എന്ന് തോന്നാം, പക്ഷേ നാം ഇത് യഥാർത്ഥത്തിൽ എങ്ങനെ ചെയ്യും?
...
ശ്രേഷ്ഠം, ഇപ്പോൾ നാം ഉയർന്ന തലത്തിൽ ഇത് എങ്ങനെ ചെയ്യാമെന്ന് മനസ്സിലാക്കി, താഴെയുള്ള അഭ്യാസത്തിൽ ഇത് പരീക്ഷിക്കാം.
...
GitHub ടോക്കൺ സൃഷ്ടിക്കുന്നത് ലളിതമായ പ്രക്രിയയാണ്. ഇതാ നിങ്ങൾ എങ്ങനെ ചെയ്യാം:

- GitHub സെറ്റിംഗ്സിലേക്ക് പോകുക – മുകളിൽ വലത് കോണിൽ നിങ്ങളുടെ പ്രൊഫൈൽ ചിത്രം ക്ലിക്ക് ചെയ്ത് സെറ്റിംഗ്സ് തിരഞ്ഞെടുക്കുക.
...
- നിങ്ങളുടെ ടോക്കൺ കോൺഫിഗർ ചെയ്യുക – റഫറൻസിനായി ഒരു നോട്ടു ചേർക്കുക, കാലാവധി സജ്ജമാക്കുക, ആവശ്യമായ സ്കോപ്പുകൾ (അനുമതികൾ) തിരഞ്ഞെടുക്കുക. ഈ കേസിൽ Models അനുമതി ചേർക്കാൻ ഉറപ്പാക്കുക.
- ടോക്കൺ ജനറേറ്റ് ചെയ്ത് കോപ്പി ചെയ്യുക – Generate token ക്ലിക്ക് ചെയ്ത് ഉടൻ കോപ്പി ചെയ്യുക, കാരണം പിന്നീട് ഇത് കാണാനാകില്ല.
...
- GitHub Models ഉപയോഗിക്കാൻ `baseUrl` സെറ്റ് ചെയ്ത് LLM ഇൻസ്റ്റൻസ് കോൺഫിഗർ ചെയ്തു.
...
- **`ChatLanguageModel` സൃഷ്ടിച്ചു**: GitHub Models ഉപയോഗിച്ച് GitHub ടോക്കൺ ഉപയോഗിച്ച് കോൺഫിഗർ ചെയ്തു
...
ഈ ഉദാഹരണം Rust അടിസ്ഥാനമാക്കിയ MCP സെർവർ പ്രവർത്തിക്കുന്നതായി കരുതുന്നു. നിങ്ങൾക്ക് ഇല്ലെങ്കിൽ, [01-first-server](../01-first-server/README.md) പാഠത്തിലേക്ക് തിരിച്ച് സെർവർ സൃഷ്ടിക്കുക.

Rust MCP സെർവർ ഉണ്ടെങ്കിൽ, ടെർമിനൽ തുറന്ന് സെർവറിന്റെ ഡയറക്ടറിയിലേക്ക് പോകുക. തുടർന്ന് പുതിയ LLM ക്ലയന്റ് പ്രോജക്ട് സൃഷ്ടിക്കാൻ താഴെയുള്ള കമാൻഡ് റൺ ചെയ്യുക:
...
`Cargo.toml` ഫയലിൽ താഴെയുള്ള ഡിപ്പൻഡൻസികൾ ചേർക്കുക:
...
> [!NOTE]
> OpenAI-ക്കായി ഔദ്യോഗിക Rust ലൈബ്രറി ഇല്ല, പക്ഷേ `async-openai` ക്രേറ്റ് ഒരു [കമ്മ്യൂണിറ്റി പരിപാലിത ലൈബ്രറി](https://platform.openai.com/docs/libraries/rust#rust) ആണ്, സാധാരണയായി ഉപയോഗിക്കുന്നത്.

`src/main.rs` ഫയൽ തുറന്ന് ഉള്ളടക്കം താഴെയുള്ള കോഡിൽ മാറ്റുക:
...
> [!IMPORTANT]
> അപ്ലിക്കേഷൻ റൺ ചെയ്യുന്നതിന് മുമ്പ് `OPENAI_API_KEY` എൻവയോൺമെന്റ് വേരിയബിൾ GitHub ടോക്കണായി സജ്ജമാക്കുക.
...
അടുത്ത ക്ലാസിൽ താഴെയുള്ള മെത്തഡുകൾ ചേർക്കുക:
...
- ഓരോ ടൂളിനും പേര്, വിവരണം, സ്കീമ ലിസ്റ്റ് ചെയ്തു. സ്കീമ പിന്നീട് ടൂൾ വിളിക്കാനായി ഉപയോഗിക്കും.
...
MCP സെർവറിൽ നിന്നുള്ള ടൂളുകൾ `list_tools` മെത്തഡ് ഉപയോഗിച്ച് ലഭിക്കും. `main` ഫംഗ്ഷനിൽ MCP ക്ലയന്റ് സജ്ജമാക്കിയ ശേഷം താഴെയുള്ള കോഡ് ചേർക്കുക:
...
1. MCP സെർവറിന്റെ പ്രതികരണം LLM ഉപയോഗിക്കാൻ കഴിയുന്ന ടൂൾ ഫോർമാറ്റിലേക്ക് മാറ്റാൻ താഴെയുള്ള കോഡ് ചേർക്കുക:
    ...
    മുകളിൽ കൊടുത്ത കോഡ് MCP സെർവറിന്റെ പ്രതികരണം എടുത്ത് LLM മനസ്സിലാക്കുന്ന ടൂൾ നിർവചന ഫോർമാറ്റിലേക്ക് മാറ്റുന്നു.
...
1. ആദ്യം, താഴെയുള്ള കൺവെർട്ടർ ഫംഗ്ഷൻ സൃഷ്ടിക്കാം:
    ...
    `convert_to_llm_tools` ഫംഗ്ഷനിൽ MCP ടൂൾ പ്രതികരണം എടുത്ത് LLM മനസ്സിലാക്കുന്ന ഫോർമാറ്റിലേക്ക് മാറ്റുന്നു.
...
1. ഈ ഫംഗ്ഷൻ ഉപയോഗിച്ച് നിലവിലുള്ള കോഡ് അപ്ഡേറ്റ് ചെയ്യാം:
...
// LLM மற்றும் MCP ഉപകരണങ്ങളുമായി AI സേവനം ക്രമീകരിക്കുക
...
- മാനുവൽ ടൂൾ പരിവർത്തനം ഒഴിവാക്കി - MCP ടൂളുകൾ LLM-സഹജമായ ഫോർമാറ്റിലേക്ക് മാറ്റുന്നത് LangChain4j ചെയ്യുന്നു

#### Rust

MCP ടൂൾ പ്രതികരണം LLM മനസ്സിലാക്കുന്ന ഫോർമാറ്റിലേക്ക് മാറ്റാൻ, ടൂൾ ലിസ്റ്റിംഗ് ഫോർമാറ്റ് ചെയ്യുന്ന ഹെൽപ്പർ ഫംഗ്ഷൻ ചേർക്കാം. `main.rs` ഫയലിൽ `main` ഫംഗ്ഷനിനു താഴെ താഴെയുള്ള കോഡ് ചേർക്കുക. ഇത് LLM-നു അഭ്യർത്ഥനകൾ അയയ്ക്കുമ്പോൾ വിളിക്കും:
...
ശ്രേഷ്ഠം, ഇനി ഉപയോക്തൃ അഭ്യർത്ഥനകൾ കൈകാര്യം ചെയ്യാം.
...
1. LLM വിളിക്കാൻ ഉപയോഗിക്കുന്ന ഒരു മെത്തഡ് ചേർക്കുക:
    ...
    - ഈ മെത്തഡ് LLM പ്രതികരണം പരിശോധിച്ച് ഏത് ടൂളുകൾ വിളിക്കണമെന്ന് കാണുന്നു:
...
1. `run` മെത്തഡ് അപ്ഡേറ്റ് ചെയ്ത് LLM-നു വിളിക്കുകയും `callTools` വിളിക്കുകയും ചെയ്യുക:

    ```typescript

    // 1. LLM-ന് ഇൻപുട്ടായി സന്ദേശങ്ങൾ സൃഷ്ടിക്കുക
...
1. LLM വിളിക്കാൻ ആവശ്യമായ ഇറക്കുമതികൾ ചേർക്കാം:
...
1. LLM വിളിക്കുന്ന ഫംഗ്ഷൻ ചേർക്കാം:
    ...
    - MCP സെർവറിൽ നിന്നുള്ള ഫംഗ്ഷനുകൾ LLM-നു നൽകി.
    - LLM ആ ഫംഗ്ഷനുകളുമായി വിളിച്ചു.
    - ഫലം പരിശോധിച്ച് ഏത് ഫംഗ്ഷനുകൾ വിളിക്കണമെന്ന് കണ്ടു.
    - വിളിക്കേണ്ട ഫംഗ്ഷനുകളുടെ ലിസ്റ്റ് പാസ്സ് ചെയ്തു.

1. അവസാന ഘട്ടം, പ്രധാന കോഡ് അപ്ഡേറ്റ് ചെയ്യാം:
    ...
    - ടൂൾ വിളിയുടെ ഫലം MCP സെർവറിലേക്ക് പ്രിന്റ് ചെയ്യുന്നു.

#### .NET

1. LLM പ്രോംപ്റ്റ് അഭ്യർത്ഥനയ്ക്കുള്ള കോഡ് കാണാം:
    ...
    - മോഡൽ, ടൂളുകൾ ഉൾപ്പെടുന്ന ഓപ്ഷൻസ് ഒബ്ജക്റ്റ് സൃഷ്ടിച്ചു.
    - LLM-നു അഭ്യർത്ഥന അയച്ചു.

1. ഒടുവിൽ, LLM ഫംഗ്ഷൻ കോളുകൾ പരിശോധിക്കാം:
    ...
    - ഓരോ ടൂൾ കോളിനും പേര്, ആർഗ്യുമെന്റുകൾ പാഴ്സ് ചെയ്ത് MCP സെർവറിൽ ടൂൾ വിളിച്ചു. ഫലം പ്രിന്റ് ചെയ്തു.
...
- LangChain4j ഫ്രെയിംവർക്ക് സ്വയം കൈകാര്യം ചെയ്യുന്നു:
  - ഉപയോക്തൃ പ്രോംപ്റ്റുകൾ ടൂൾ കോളുകളായി മാറ്റൽ
  - LLM തീരുമാനപ്രകാരം MCP ടൂളുകൾ വിളിക്കൽ
  - LLM-നും MCP സെർവറിനും ഇടയിലെ സംഭാഷണ പ്രവാഹം നിയന്ത്രിക്കൽ
- `bot.chat()` സ്വാഭാവിക ഭാഷാ പ്രതികരണങ്ങൾ നൽകുന്നു, MCP ടൂൾ ഫലങ്ങൾ ഉൾപ്പെടെ
...
നാം LLM-നു പല തവണ വിളിക്കും, അതിനാൽ LLM വിളി കൈകാര്യം ചെയ്യുന്ന ഫംഗ്ഷൻ നിർവചിക്കാം. `main.rs` ഫയലിൽ താഴെയുള്ള ഫംഗ്ഷൻ ചേർക്കുക:
...
LLM-ൽ നിന്നുള്ള പ്രതികരണം `choices` എന്ന ഒരു അറേ അടങ്ങിയിരിക്കും. ഏതെങ്കിലും `tool_calls` ഉണ്ടോ എന്ന് പരിശോധിക്കാൻ നമുക്ക് ഫലം പ്രോസസ് ചെയ്യേണ്ടതുണ്ട്. LLM ഒരു പ്രത്യേക ടൂൾ ആഗ്യുമെന്റുകളോടുകൂടി വിളിക്കണമെന്ന് അഭ്യർത്ഥിക്കുന്നുവെന്ന് ഇത് നമ്മുക്ക് അറിയിക്കും. LLM പ്രതികരണം കൈകാര്യം ചെയ്യാൻ ഒരു ഫംഗ്ഷൻ നിർവചിക്കാൻ താഴെ കൊടുത്തിരിക്കുന്ന കോഡ് നിങ്ങളുടെ `main.rs` ഫയലിന്റെ അടിയിൽ ചേർക്കുക:
...
`tool_calls` ഉണ്ടെങ്കിൽ, അത് ടൂൾ വിവരങ്ങൾ എടുക്കുകയും, ടൂൾ അഭ്യർത്ഥനയോടെ MCP സെർവറെ വിളിക്കുകയും, ഫലങ്ങൾ സംഭാഷണ സന്ദേശങ്ങളിൽ ചേർക്കുകയും ചെയ്യും. തുടർന്ന് LLM-നൊപ്പം സംഭാഷണം തുടരുകയും, സന്ദേശങ്ങൾ അസിസ്റ്റന്റിന്റെ പ്രതികരണവും ടൂൾ കോൾ ഫലങ്ങളും ഉൾപ്പെടുത്തി അപ്ഡേറ്റ് ചെയ്യപ്പെടുകയും ചെയ്യും.

LLM MCP കോൾസിനായി തിരികെ നൽകുന്ന ടൂൾ കോൾ വിവരങ്ങൾ എടുക്കാൻ, കോൾ നടത്താൻ ആവശ്യമായ എല്ലാ വിവരങ്ങളും എടുക്കുന്ന മറ്റൊരു സഹായക ഫംഗ്ഷൻ നമുക്ക് ചേർക്കാം. നിങ്ങളുടെ `main.rs` ഫയലിന്റെ അടിയിൽ താഴെ കൊടുത്തിരിക്കുന്ന കോഡ് ചേർക്കുക:
...
എല്ലാ ഭാഗങ്ങളും സജ്ജമാക്കിയതോടെ, പ്രാഥമിക ഉപയോക്തൃ പ്രോംപ്റ്റ് കൈകാര്യം ചെയ്ത് LLM-നെ വിളിക്കാൻ നമുക്ക് സാധിക്കും. നിങ്ങളുടെ `main` ഫംഗ്ഷൻ താഴെ കൊടുത്തിരിക്കുന്ന കോഡ് ഉൾപ്പെടുത്താൻ അപ്ഡേറ്റ് ചെയ്യുക:
...
പരീക്ഷണത്തിൽ നിന്നുള്ള കോഡ് എടുത്ത് കൂടുതൽ ടൂളുകളുമായി സെർവർ വികസിപ്പിക്കുക. തുടർന്ന് LLM പോലുള്ള ഒരു ക്ലയന്റ് സൃഷ്ടിച്ച് വ്യത്യസ്ത പ്രോംപ്റ്റുകൾ ഉപയോഗിച്ച് പരീക്ഷിച്ച് നിങ്ങളുടെ സെർവർ ടൂളുകൾ ഡൈനാമിക്കായി വിളിക്കപ്പെടുന്നുണ്ടെന്ന് ഉറപ്പാക്കുക. ഈ രീതിയിൽ ക്ലയന്റ് നിർമ്മിക്കുന്നത് ഉപയോക്താവിന് മികച്ച അനുഭവം നൽകും, കാരണം അവർ കൃത്യമായ ക്ലയന്റ് കമാൻഡുകൾക്ക് പകരം പ്രോംപ്റ്റുകൾ ഉപയോഗിച്ച് പ്രവർത്തിക്കാനും MCP സെർവർ വിളിക്കപ്പെടുന്നതിനെ അവഗണിക്കാനും കഴിയും.
...
- നിങ്ങളുടെ ക്ലയന്റിൽ LLM ചേർക്കുന്നത് MCP സെർവറുകളുമായി ഉപയോക്താക്കൾക്ക് മെച്ചപ്പെട്ട ഇടപെടൽ മാർഗം നൽകുന്നു.
