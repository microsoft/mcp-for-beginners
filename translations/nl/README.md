...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T17:01:49+00:00",
...
Welkom bij jouw reis in het Model Context Protocol! Als je je ooit hebt afgevraagd hoe AI-toepassingen communiceren met verschillende tools en diensten, sta je op het punt een elegante oplossing te ontdekken die de manier waarop ontwikkelaars intelligente systemen bouwen transformeert.
...
- 📘 [MCP Documentatie](https://modelcontextprotocol.io/) – Dit is jouw belangrijkste bron voor stapsgewijze tutorials en gebruikershandleidingen. De documentatie is geschreven met beginners in gedachten en biedt duidelijke voorbeelden die je in je eigen tempo kunt volgen.
- 📜 [MCP Specificatie](https://modelcontextprotocol.io/docs/) – Zie dit als je uitgebreide naslagwerk. Terwijl je door de curriculum werkt, zul je hier vaak terugkomen om specifieke details op te zoeken en geavanceerde functies te verkennen.
...
- 🌐 [MCP Community](https://github.com/orgs/modelcontextprotocol/discussions) – Sluit je aan bij mede-lerenden en ervaren ontwikkelaars in discussies over MCP. Het is een ondersteunende community waar vragen welkom zijn en kennis vrij wordt gedeeld.
...
• **Begrijp MCP basisprincipes**: Je zult begrijpen wat het Model Context Protocol is en waarom het revolutionair is voor hoe AI-toepassingen samenwerken, met behulp van analogieën en voorbeelden die logisch zijn.

• **Bouw je eerste MCP-server**: Je zult een werkende MCP-server maken in je favoriete programmeertaal, beginnend met eenvoudige voorbeelden en je vaardigheden stap voor stap uitbreiden.
...
• **Implementeer beveiligingsbest practices**: Je zult begrijpen hoe je je MCP-implementaties veilig en beschermd houdt, zowel voor je toepassingen als je gebruikers.
...
• **Word lid van de MCP-community**: Je wordt onderdeel van een groeiende community van ontwikkelaars die de toekomst van AI-toepassingsontwikkeling vormgeven.

## Essentiële Achtergrond

Voordat we in de specifieke details van MCP duiken, zorgen we ervoor dat je je comfortabel voelt met enkele basisconcepten. Maak je geen zorgen als je geen expert bent in deze gebieden - we leggen alles uit wat je moet weten terwijl we verder gaan!

### Begrijpen van Protocollen (De Basis)

Zie een protocol als de regels voor een gesprek. Wanneer je een vriend belt, weet je beiden dat je "hallo" zegt bij het opnemen, om de beurt spreekt en "tot ziens" zegt wanneer je klaar bent. Computerprogramma's hebben vergelijkbare regels nodig om effectief te communiceren.

MCP is een protocol - een set van afgesproken regels die AI-modellen en toepassingen helpen om productieve "gesprekken" te voeren met tools en diensten. Net zoals gespreksregels menselijke communicatie soepeler maken, maakt MCP de communicatie van AI-toepassingen veel betrouwbaarder en krachtiger.

### Client-Server Relaties (Hoe Programma's Samenwerken)

Je gebruikt dagelijks client-server relaties! Wanneer je een webbrowser (de client) gebruikt om een website te bezoeken, maak je verbinding met een webserver die je de inhoud van de pagina stuurt. De browser weet hoe informatie op te vragen, en de server weet hoe te reageren.
...
Stel je voor dat elke autofabrikant verschillende vormen van benzinepompen zou gebruiken - je zou een andere adapter nodig hebben voor elke auto! Standaardisatie betekent het eens worden over gemeenschappelijke benaderingen zodat dingen naadloos samenwerken.

MCP biedt deze standaardisatie voor AI-toepassingen. In plaats van dat elk AI-model aangepaste code nodig heeft om met elke tool te werken, creëert MCP een universele manier voor hen om te communiceren. Dit betekent dat ontwikkelaars tools één keer kunnen bouwen en ze laten werken met veel verschillende AI-systemen.

## 🧭 Overzicht van Jouw Leerpad

Jouw MCP-reis is zorgvuldig gestructureerd om je vertrouwen en vaardigheden geleidelijk op te bouwen. Elke fase introduceert nieuwe concepten terwijl het versterkt wat je al hebt geleerd.

### 🌱 Basisfase: Begrijpen van de Basisprincipes (Modules 0-2)

Hier begint jouw avontuur! We introduceren je in MCP-concepten met behulp van vertrouwde analogieën en eenvoudige voorbeelden. Je zult begrijpen wat MCP is, waarom het bestaat en hoe het past in de bredere wereld van AI-ontwikkeling.

• **Module 0 - Introductie tot MCP**: We beginnen met het verkennen van wat MCP is en waarom het zo belangrijk is voor moderne AI-toepassingen. Je zult voorbeelden uit de echte wereld zien van MCP in actie en begrijpen hoe het veelvoorkomende problemen van ontwikkelaars oplost.
...
Deze module bevat meerdere praktische gidsen waarmee je kunt oefenen in je favoriete programmeertaal. Je zult je eerste server maken, een client bouwen om ermee te verbinden en zelfs integreren met populaire ontwikkeltools zoals VS Code.
...
Met de basis onder de knie ben je klaar om meer geavanceerde MCP-functies te verkennen. We behandelen praktische implementatiestrategieën, debuggingtechnieken en geavanceerde onderwerpen zoals multimodale AI-integratie.
...
Module 11 verdient speciale aandacht - het is een compleet leerpad met 13 praktische labs waarin je leert hoe je productieklare MCP-servers bouwt met PostgreSQL-integratie. Het is als een afsluitend project dat alles wat je hebt geleerd samenbrengt!
...
| 3.11 | Eenvoudige authenticatie | Een hoofdstuk dat je vanaf het begin auth en RBAC laat zien | [Handleiding](./03-GettingStarted/11-simple-auth/README.md) |
...
| 05 | Geavanceerde onderwerpen in MCP | Multimodale AI, schaalbaarheid, gebruik in ondernemingen | [Lees meer](./05-AdvancedTopics/README.md) |
| 5.1 | Azure-integratie | MCP-integratie met Azure | [Handleiding](./05-AdvancedTopics/mcp-integration/README.md) |
| 5.2 | Multimodaliteit | Werken met meerdere modaliteiten | [Handleiding](./05-AdvancedTopics/mcp-multi-modality/README.md) |
...
| 5.11 | Realtime zoeken | Implementeer realtime zoekfuncties | [Handleiding](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
...
| 10 | Praktische workshop | Een MCP-server bouwen met AI Toolkit | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
| **Module 11: MCP Server Hands On Lab** | | | |
| 11 | MCP Server Database-integratie | Uitgebreid leerpad met 13 labs voor PostgreSQL-integratie | [Labs](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.7 | Toolontwikkeling | Maak databasequerytools en schema-inspectie | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
- Gedetailleerde uitleg van elke sectie van de repository
...
We onderhouden een gedetailleerde [Changelog](./changelog.md) die alle belangrijke updates aan de curriculummaterialen bijhoudt, zodat je op de hoogte blijft van de nieuwste verbeteringen en toevoegingen.
...
Deze dag draait helemaal om het ondersteunen van ontwikkelaars bij het gebruik van MCP in hun ontwikkelworkflow en het vieren van de geweldige MCP-community. We worden vergezeld door communityleden en partners zoals Arcade, Block, Okta en Neon om te zien hoe zij samenwerken met Microsoft om een open, uitbreidbaar MCP-ecosysteem vorm te geven.  
...
Deze dag is bedoeld voor MCP-bouwers. We duiken diep in implementatiestrategieën en best practices voor het creëren van MCP-servers en het integreren van MCP in je AI-workflows.
...
Ben je een ontwikkelaar, toolbouwer of AI-productstrateeg? Deze dag zit vol met inzichten die je nodig hebt om schaalbare, veilige en toekomstbestendige MCP-oplossingen te bouwen.

### MCP Boot Camp Augustus 2025  
Leer in intensieve videosessies hoe je MCP-servers maakt, integreert met VS Code en professioneel implementeert op Azure, gebaseerd op de MCP voor Beginners-curriculum. Je verlaat de bootcamp met praktische vaardigheden in een technologie die al door grote bedrijven wordt gebruikt.

#### [➡️Bekijk MCP Bootcamp On Demand | Engels](https://developer.microsoft.com/en-us/reactor/series/s-1568/)  
#### [➡️Bekijk MCP Bootcamp On Demand | Brasil](https://developer.microsoft.com/en-us/reactor/series/S-1566/)  
...
Leer alles over het Model Context Protocol (MCP), een geavanceerd framework ontworpen om interacties tussen AI-modellen en clientapplicaties te standaardiseren. In deze beginnersvriendelijke sessie introduceren we MCP en begeleiden we je bij het maken van je eerste MCP-server.  
...
Gefeliciteerd! Je hebt zojuist de eerste stap gezet in een spannende reis die je programmeermogelijkheden zal uitbreiden en je verbindt met de nieuwste ontwikkelingen in AI.

### Wat je al hebt bereikt  

Door deze introductie te lezen, heb je al een basis gelegd voor je MCP-kennis. Je begrijpt wat MCP is, waarom het belangrijk is en hoe dit curriculum je leerproces ondersteunt. Dat is een belangrijke prestatie en het begin van je expertise in deze belangrijke technologie.

### Het avontuur dat voor je ligt  

Terwijl je door de modules gaat, onthoud dat elke expert ooit een beginner was. De concepten die nu misschien ingewikkeld lijken, worden vanzelfsprekend naarmate je oefent en ze toepast. Elke kleine stap bouwt aan krachtige vaardigheden die je gedurende je ontwikkelcarrière van pas zullen komen.

### Jouw ondersteuningsnetwerk  

Je sluit je aan bij een community van leerlingen en experts die gepassioneerd zijn over MCP en anderen graag willen helpen slagen. Of je nu vastzit bij een code-uitdaging of enthousiast bent om een doorbraak te delen, de community is er om je te ondersteunen.
