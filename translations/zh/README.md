...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T17:52:28+00:00",
...
| 标题 | 描述 | 链接 |
|--|--|--|
| **00 - MCP 介绍** | 模型上下文协议及其在 AI 流水线中的重要性概述，包括什么是模型上下文协议、标准化的意义以及实际应用和优势 | [介绍](./00-Introduction/README.md) |
| **01 - 核心概念解析** | 深入探讨 MCP 的核心概念，包括客户端-服务器架构、关键协议组件和消息模式 | [核心概念](./01-CoreConcepts/README.md) |
| **02 - MCP 中的安全性** | 识别基于 MCP 系统的安全威胁，安全实现的技术和最佳实践 | [安全性](./02-Security/readme.md) |
...
| **3.3 - 搭配大型语言模型的客户端** | 使用 MCP 协议搭建包含大型语言模型（LLM）的客户端 | [搭配 LLM 的客户端](./03-GettingStarted/03-llm-client/README.md) |
...
| **3.6 - 使用 AI 工具包** | AI 工具包是一个极佳的工具，帮助你管理 AI 和 MCP 工作流 | [使用 AI 工具包](./03-GettingStarted/06-aitk/README.md) |
| **3.7 - 测试你的服务器** | 测试是开发过程中的重要环节，本节将指导你使用多种工具进行测试 | [测试你的服务器](./03-GettingStarted/07-testing/README.md) |
| **3.8 - 部署你的服务器** | 如何从本地开发过渡到生产环境？本节将帮助你开发并部署服务器 | [部署你的服务器](./03-GettingStarted/08-deployment/README.md) |
| **04 - 实践应用** | 跨语言 SDK 使用，调试、测试与验证，设计可复用的提示模板和工作流 | [实践应用](./04-PracticalImplementation/README.md) |
...
| **07 - 早期采用经验分享** | 真实案例及成功经验，构建和部署基于 MCP 的解决方案，趋势与未来路线图 | [经验分享](./07-LessonsFromEarlyAdoption/README.md) |
| **08 - MCP 最佳实践** | 性能调优与优化，设计容错 MCP 系统，测试与弹性策略 | [最佳实践](./08-BestPractices/README.md) |
| **09 - MCP 案例研究** | 深入解析 MCP 解决方案架构、部署蓝图和集成技巧，带注释的图示和项目演示 | [案例研究](./09-CaseStudy/README.md) |
...
本项目欢迎贡献和建议。大多数贡献需要你同意一份贡献者许可协议（CLA），声明你拥有并确实授予我们使用你贡献内容的权利。详情请访问 <https://cla.opensource.microsoft.com>。

当你提交拉取请求时，CLA 机器人会自动判断你是否需要提供 CLA，并在 PR 上进行相应标记（例如状态检查、评论）。只需按照机器人提供的指示操作即可。你在所有使用我们 CLA 的仓库中只需完成一次此流程。

本项目已采用 [Microsoft 开源行为准则](https://opensource.microsoft.com/codeofconduct/)。  
更多信息请参见 [行为准则常见问题](https://opensource.microsoft.com/codeofconduct/faq/) 或通过 [opencode@microsoft.com](mailto:opencode@microsoft.com) 联系我们，提出任何额外问题或建议。
