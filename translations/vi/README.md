...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T17:04:00+00:00",
...
Hãy nghĩ về MCP như một bộ dịch thuật toàn cầu cho các ứng dụng AI - giống như cách cổng USB cho phép bạn kết nối bất kỳ thiết bị nào với máy tính, MCP cho phép các mô hình AI kết nối với bất kỳ công cụ hoặc dịch vụ nào theo cách chuẩn hóa. Dù bạn đang xây dựng chatbot đầu tiên hay làm việc trên các quy trình AI phức tạp, hiểu MCP sẽ giúp bạn tạo ra các ứng dụng linh hoạt và mạnh mẽ hơn.

Giáo trình này được thiết kế với sự kiên nhẫn và chăm sóc cho hành trình học tập của bạn. Chúng tôi sẽ bắt đầu với các khái niệm đơn giản mà bạn đã hiểu và dần dần xây dựng chuyên môn của bạn thông qua thực hành thực tế bằng ngôn ngữ lập trình yêu thích của bạn. Mỗi bước đều có giải thích rõ ràng, ví dụ thực tế và rất nhiều sự khích lệ.

Khi hoàn thành hành trình này, bạn sẽ tự tin xây dựng máy chủ MCP của riêng mình, tích hợp chúng với các nền tảng AI phổ biến và hiểu cách công nghệ này đang định hình tương lai của phát triển AI. Hãy cùng bắt đầu cuộc phiêu lưu thú vị này!

### Tài liệu và thông số kỹ thuật chính thức

Những tài nguyên này sẽ trở nên hữu ích hơn khi bạn hiểu rõ hơn, nhưng đừng cảm thấy áp lực phải đọc hết ngay lập tức. Hãy bắt đầu với những phần mà bạn quan tâm nhất!
- 📘 [Tài liệu MCP](https://modelcontextprotocol.io/) – Đây là tài nguyên chính của bạn để tìm hiểu các hướng dẫn từng bước và tài liệu hướng dẫn sử dụng. Tài liệu được viết dành cho người mới bắt đầu, cung cấp các ví dụ rõ ràng mà bạn có thể làm theo với tốc độ của riêng mình.
- 📜 [Thông số kỹ thuật MCP](https://modelcontextprotocol.io/docs/) – Hãy coi đây là tài liệu tham khảo toàn diện của bạn. Khi bạn làm việc qua giáo trình, bạn sẽ thường xuyên quay lại đây để tra cứu chi tiết cụ thể và khám phá các tính năng nâng cao.
- 📜 [Thông số kỹ thuật MCP gốc](https://spec.modelcontextprotocol.io/) – Bao gồm các chi tiết kỹ thuật bổ sung có thể hữu ích cho các triển khai nâng cao. Nó sẽ có sẵn khi bạn cần, nhưng đừng lo lắng về nó khi bạn mới bắt đầu.
...
• **Hiểu các nguyên tắc cơ bản của MCP**: Bạn sẽ nắm được MCP là gì và tại sao nó lại cách mạng hóa cách các ứng dụng AI làm việc cùng nhau, thông qua các ví dụ và phép so sánh dễ hiểu.

• **Xây dựng máy chủ MCP đầu tiên của bạn**: Bạn sẽ tạo một máy chủ MCP hoạt động bằng ngôn ngữ lập trình yêu thích của mình, bắt đầu với các ví dụ đơn giản và phát triển kỹ năng của mình từng bước.

• **Kết nối mô hình AI với các công cụ thực tế**: Bạn sẽ học cách kết nối khoảng cách giữa các mô hình AI và các dịch vụ thực tế, mang lại cho ứng dụng của bạn những khả năng mạnh mẽ mới.

• **Thực hiện các thực hành bảo mật tốt nhất**: Bạn sẽ hiểu cách giữ cho các triển khai MCP của mình an toàn và bảo mật, bảo vệ cả ứng dụng và người dùng của bạn.
...
• **Tham gia cộng đồng MCP**: Bạn sẽ trở thành một phần của cộng đồng các nhà phát triển đang định hình tương lai của phát triển ứng dụng AI. 

## Kiến thức nền tảng cần thiết

Trước khi chúng ta đi sâu vào các chi tiết cụ thể của MCP, hãy đảm bảo bạn cảm thấy thoải mái với một số khái niệm cơ bản. Đừng lo lắng nếu bạn không phải là chuyên gia trong các lĩnh vực này - chúng tôi sẽ giải thích mọi thứ bạn cần biết khi tiến hành!

### Hiểu về giao thức (Nền tảng)

Hãy nghĩ về giao thức như các quy tắc cho một cuộc trò chuyện. Khi bạn gọi điện cho một người bạn, cả hai đều biết nói "xin chào" khi trả lời, lần lượt nói chuyện và nói "tạm biệt" khi kết thúc. Các chương trình máy tính cũng cần các quy tắc tương tự để giao tiếp hiệu quả.

MCP là một giao thức - một tập hợp các quy tắc đã được thống nhất giúp các mô hình AI và ứng dụng có "cuộc trò chuyện" hiệu quả với các công cụ và dịch vụ. Giống như việc có các quy tắc trò chuyện làm cho giao tiếp giữa con người trở nên suôn sẻ hơn, việc có MCP làm cho giao tiếp giữa các ứng dụng AI trở nên đáng tin cậy và mạnh mẽ hơn.

### Mối quan hệ Client-Server (Cách các chương trình làm việc cùng nhau)

Bạn đã sử dụng mối quan hệ client-server hàng ngày! Khi bạn sử dụng trình duyệt web (client) để truy cập một trang web, bạn đang kết nối với một máy chủ web gửi nội dung trang cho bạn. Trình duyệt biết cách yêu cầu thông tin, và máy chủ biết cách phản hồi.
...
MCP cung cấp sự chuẩn hóa này cho các ứng dụng AI. Thay vì mỗi mô hình AI cần mã tùy chỉnh để làm việc với mỗi công cụ, MCP tạo ra một cách phổ biến để chúng giao tiếp. Điều này có nghĩa là các nhà phát triển có thể xây dựng công cụ một lần và làm cho chúng hoạt động với nhiều hệ thống AI khác nhau.

## 🧭 Tổng quan về lộ trình học tập của bạn
...
Module này bao gồm nhiều hướng dẫn thực hành cho phép bạn thực hành bằng ngôn ngữ lập trình yêu thích của mình. Bạn sẽ tạo máy chủ đầu tiên của mình, xây dựng một client để kết nối với nó, và thậm chí tích hợp với các công cụ phát triển phổ biến như VS Code.
...
Module 11 xứng đáng được nhắc đến đặc biệt - đây là một lộ trình học tập thực hành gồm 13 bài thực hành hoàn chỉnh, hướng dẫn bạn xây dựng các máy chủ MCP sẵn sàng cho sản xuất với tích hợp PostgreSQL. Nó giống như một dự án tổng kết, kết hợp tất cả những gì bạn đã học!

### 📚 Cấu trúc chương trình học hoàn chỉnh

| Module | Chủ đề | Mô tả | Liên kết |
|--------|--------|-------|----------|
| **Module 1-3: Kiến thức cơ bản** | | | |
| 00 | Giới thiệu về MCP | Tổng quan về Giao thức Ngữ cảnh Mô hình và tầm quan trọng của nó trong các pipeline AI | [Đọc thêm](./00-Introduction/README.md) |
...
| 3.8 | Kiểm tra | Kiểm tra triển khai máy chủ MCP của bạn | [Hướng dẫn](./03-GettingStarted/08-testing/README.md) |
| 3.9 | Triển khai | Triển khai máy chủ MCP vào sản xuất | [Hướng dẫn](./03-GettingStarted/09-deployment/README.md) |
| 3.10 | Sử dụng máy chủ nâng cao | Sử dụng máy chủ nâng cao để sử dụng các tính năng nâng cao và cải thiện kiến trúc | [Hướng dẫn](./03-GettingStarted/10-advanced/README.md) |
| 3.11 | Xác thực đơn giản | Một chương trình hướng dẫn bạn xác thực từ đầu và RBAC | [Hướng dẫn](./03-GettingStarted/11-simple-auth/README.md) |
| **Module 4-5: Thực hành & Nâng cao** | | | |
| 04 | Triển khai thực tế | SDKs, gỡ lỗi, kiểm tra, mẫu prompt tái sử dụng | [Đọc thêm](./04-PracticalImplementation/README.md) |
...
| 11 | Tích hợp cơ sở dữ liệu máy chủ MCP | Lộ trình học tập thực hành gồm 13 bài thực hành về tích hợp PostgreSQL | [Labs](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | Kiến trúc cốt lõi | Hiểu kiến trúc máy chủ MCP, các lớp cơ sở dữ liệu, và các mẫu bảo mật | [Lab 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
Một trong những phần thú vị nhất khi học MCP là thấy kỹ năng lập trình của bạn phát triển dần dần. Chúng tôi đã thiết kế các ví dụ mã để bắt đầu đơn giản và trở nên phức tạp hơn khi hiểu biết của bạn sâu sắc hơn. Đây là cách chúng tôi giới thiệu các khái niệm - với mã dễ hiểu nhưng thể hiện các nguyên tắc MCP thực tế, bạn sẽ hiểu không chỉ mã này làm gì, mà còn tại sao nó được cấu trúc như vậy và nó phù hợp như thế nào trong các ứng dụng MCP lớn hơn.
...
- Hiểu biết về mô hình máy chủ-khách và APIs
...
- Lộ trình học tập được khuyến nghị cho các cấp độ kỹ năng khác nhau
- Các tài nguyên bổ sung để bổ sung hành trình học tập của bạn

### Changelog

Chúng tôi duy trì một [Changelog](./changelog.md) chi tiết theo dõi tất cả các cập nhật quan trọng đối với tài liệu chương trình học, để bạn có thể cập nhật với những cải tiến và bổ sung mới nhất.
...
4. Các tài nguyên bổ sung cho người học nâng cao  
...
Hãy sẵn sàng cho hai ngày tìm hiểu kỹ thuật sâu sắc, kết nối cộng đồng, và học tập thực hành tại MCP Dev Days, một sự kiện trực tuyến dành riêng cho Giao thức Ngữ cảnh Mô hình (MCP) — tiêu chuẩn mới nổi kết nối các mô hình AI và các công cụ mà chúng dựa vào.
...
Dù bạn mới bắt đầu với MCP hay đã xây dựng với nó, Ngày 1 sẽ mang đến cảm hứng và những bài học thực tiễn.
...
Học qua các video chuyên sâu cách tạo máy chủ MCP, tích hợp với VS Code, và triển khai chuyên nghiệp trên Azure dựa trên nội dung từ chương trình học MCP cho người mới bắt đầu. Bạn sẽ có được các kỹ năng thực tiễn trong một công nghệ mà các công ty lớn đã và đang sử dụng.
...
Hãy tìm hiểu về Model Context Protocol (MCP), một khung công nghệ tiên tiến được thiết kế để chuẩn hóa các tương tác giữa các mô hình AI và ứng dụng khách. Thông qua buổi học thân thiện với người mới bắt đầu này, chúng tôi sẽ giới thiệu MCP và hướng dẫn bạn cách tạo máy chủ MCP đầu tiên của mình.
...
Chúc mừng! Bạn vừa thực hiện bước đầu tiên trong một hành trình thú vị sẽ mở rộng khả năng lập trình của bạn và kết nối bạn với sự phát triển tiên tiến của AI.

### Những gì bạn đã đạt được

Bằng cách đọc qua phần giới thiệu này, bạn đã bắt đầu xây dựng nền tảng kiến thức MCP của mình. Bạn hiểu MCP là gì, tại sao nó quan trọng, và cách chương trình học này sẽ hỗ trợ hành trình học tập của bạn. Đây là một thành tựu đáng kể và là khởi đầu cho chuyên môn của bạn trong công nghệ quan trọng này.
...
Bạn đang tham gia vào một cộng đồng học tập và chuyên gia đam mê MCP và sẵn sàng giúp đỡ người khác thành công. Dù bạn gặp khó khăn với một thử thách mã hóa hay hào hứng chia sẻ một bước đột phá, cộng đồng luôn ở đây để hỗ trợ hành trình của bạn.
...
Chương trình học này sẽ ngày càng mạnh mẽ hơn nhờ vào sự đóng góp từ những học viên như bạn! Dù bạn sửa lỗi chính tả, đề xuất một lời giải thích rõ ràng hơn, hay thêm một ví dụ mới, sự đóng góp của bạn sẽ giúp những người mới bắt đầu khác thành công.
...
Toàn bộ chương trình học này được cung cấp theo giấy phép MIT [LICENSE](../../LICENSE), nghĩa là bạn có thể sử dụng, chỉnh sửa, và chia sẻ nó tự do. Điều này hỗ trợ sứ mệnh của chúng tôi trong việc làm cho kiến thức MCP trở nên dễ tiếp cận với các nhà phát triển trên toàn thế giới.

## 🤝 Hướng dẫn đóng góp

Dự án này chào đón các đóng góp và đề xuất. Hầu hết các đóng góp yêu cầu bạn đồng ý với Thỏa thuận Giấy phép Người đóng góp (CLA) tuyên bố rằng bạn có quyền, và thực sự cấp cho chúng tôi quyền sử dụng đóng góp của bạn. Để biết chi tiết, hãy truy cập <https://cla.opensource.microsoft.com>.

Khi bạn gửi một pull request, bot CLA sẽ tự động xác định liệu bạn có cần cung cấp CLA hay không và trang trí PR một cách phù hợp (ví dụ: kiểm tra trạng thái, bình luận). Chỉ cần làm theo hướng dẫn của bot. Bạn chỉ cần làm điều này một lần trên tất cả các kho sử dụng CLA của chúng tôi.
