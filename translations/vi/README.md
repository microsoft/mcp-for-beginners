...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:25:44+00:00",
...
• **Hiểu các nguyên tắc cơ bản của MCP**: Bạn sẽ nắm được MCP là gì và tại sao nó lại cách mạng hóa cách các ứng dụng AI hoạt động cùng nhau, thông qua các phép so sánh và ví dụ dễ hiểu.
...
Module 11 xứng đáng được nhắc đến đặc biệt - đây là một lộ trình học tập thực hành gồm 13 bài lab hoàn chỉnh, hướng dẫn bạn xây dựng các máy chủ MCP sẵn sàng cho sản xuất với tích hợp PostgreSQL. Đây giống như một dự án tổng kết, tập hợp tất cả những gì bạn đã học!
...
| 3.10 | Sử dụng máy chủ nâng cao | Sử dụng máy chủ nâng cao để khai thác các tính năng tiên tiến và cải thiện kiến trúc | [Hướng dẫn](./03-GettingStarted/10-advanced/README.md) |
| 3.11 | Xác thực đơn giản | Một chương trình hướng dẫn bạn từ xác thực cơ bản đến RBAC | [Hướng dẫn](./03-GettingStarted/11-simple-auth/README.md) |
...
| 5.7 | Mở rộng quy mô | Mở rộng quy mô triển khai MCP | [Hướng dẫn](./05-AdvancedTopics/mcp-scaling/README.md) |
