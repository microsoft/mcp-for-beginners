...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:36:47+00:00",
...
| 3.8 | Тестване | Тествайте вашата имплементация на MCP сървър | [Ръководство](./03-GettingStarted/08-testing/README.md) |
| 3.9 | Деплоймънт | Деплойвайте MCP сървъри в продукция | [Ръководство](./03-GettingStarted/09-deployment/README.md) |
| 3.10 | Усъвършенствано използване на сървъри | Използвайте усъвършенствани сървъри за подобрена архитектура и функции | [Ръководство](./03-GettingStarted/10-advanced/README.md) |
...
| 04 | Практическа имплементация | SDKs, дебъгване, тестване, шаблони за подканващи текстове | [Прочетете повече](./04-PracticalImplementation/README.md) |
...
| 5.4 | Root Contexts | Разбиране и имплементация на root contexts | [Ръководство](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
Ако имате обратна връзка за продукта или срещнете грешки при разработката, посетете:
