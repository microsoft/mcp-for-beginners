...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T17:14:35+00:00",
...
# 🚀 Учебна програма за начинаещи в Model Context Protocol (MCP)
...
Добре дошли в пътешествието ви в света на Model Context Protocol! Ако някога сте се чудили как AI приложенията комуникират с различни инструменти и услуги, сега ще откриете елегантното решение, което трансформира начина, по който разработчиците създават интелигентни системи.
...
Тази учебна програма е създадена с внимание и грижа за вашето обучение. Ще започнем с прости концепции, които вече разбирате, и постепенно ще изградим вашата експертиза чрез практически упражнения в любимия ви програмен език. Всеки етап включва ясни обяснения, практични примери и много подкрепа по пътя.
...
Тези ресурси стават по-ценни с напредването на вашето разбиране, но не се чувствайте притиснати да четете всичко веднага. Започнете с областите, които ви интересуват най-много!
- 📘 [MCP Документация](https://modelcontextprotocol.io/) – Това е вашият основен ресурс за стъпка по стъпка уроци и ръководства за потребители. Документацията е написана с мисъл за начинаещи, предоставяйки ясни примери, които можете да следвате със собствено темпо.
- 📜 [MCP Спецификация](https://modelcontextprotocol.io/docs/) – Мислете за това като за вашето подробно ръководство. Докато работите по учебната програма, ще се връщате тук, за да търсите конкретни детайли и да изследвате напреднали функции.
- 📜 [Оригинална MCP Спецификация](https://spec.modelcontextprotocol.io/) – Тук се съдържат допълнителни технически детайли, които могат да бъдат полезни за напреднали реализации. Тя е на разположение, когато ви потрябва, но не се притеснявайте за нея в началото.
- 🧑‍💻 [MCP GitHub Хранилище](https://github.com/modelcontextprotocol) – Тук ще намерите SDK, инструменти и примери за код на множество програмни езици. Това е като съкровищница от практични примери и готови за употреба компоненти.
...
• **Свързване на AI модели с реални инструменти**: Ще научите как да преодолеете разликата между AI модели и реални услуги, предоставяйки на приложенията си мощни нови възможности.

• **Прилагане на най-добрите практики за сигурност**: Ще разберете как да запазите вашите MCP реализации безопасни и сигурни, защитавайки както приложенията си, така и потребителите си.

• **Уверено внедряване**: Ще знаете как да преминете от разработка към продукция с вашите MCP проекти, използвайки практични стратегии за внедряване, които работят в реалния свят.
...
В MCP имаме подобна връзка: AI моделите действат като клиенти, които искат информация или действия, докато MCP сървърите предоставят тези възможности. Това е като да имате полезен асистент (сървър), на който AI може да поиска да изпълни конкретни задачи.

### Защо стандартизацията е важна (Да направим нещата съвместими)

Представете си, ако всеки производител на автомобили използваше различни форми на бензинови помпи - ще ви трябва различен адаптер за всяка кола! Стандартизацията означава съгласие за общи подходи, така че нещата да работят заедно безпроблемно.
...
• **Модул 0 - Въведение в MCP**: Ще започнем с изследване на това какво е MCP и защо е толкова важно за съвременните AI приложения. Ще видите примери от реалния свят за MCP в действие и ще разберете как решава често срещани проблеми, пред които са изправени разработчиците.
...
Сега започва истинското забавление! Ще получите практически опит в създаването на реални MCP сървъри и клиенти. Не се притеснявайте - ще започнем просто и ще ви водим през всяка стъпка.
...
Ще научите също как да мащабирате вашите MCP реализации за продукционна употреба и да ги интегрирате с облачни платформи като Azure. Тези модули ви подготвят да изграждате MCP решения, които могат да се справят с реални изисквания.
...
Модул 11 заслужава специално внимание - това е пълен практически път с 13 лаборатории, който ви учи как да изграждате готови за производство MCP сървъри с интеграция на PostgreSQL. Това е като завършващ проект, който обединява всичко, което сте научили!
...
| 3.9 | Деплоймент | Деплойвайте MCP сървъри в продукция | [Ръководство](./03-GettingStarted/09-deployment/README.md) |
...
| 04 | Практическо прилагане | SDKs, дебъгване, тестване, шаблони за подканване | [Прочетете повече](./04-PracticalImplementation/README.md) |
...
| 5.3 | OAuth2 Демонстрация | Прилагане на автентикация с OAuth2 | [Ръководство](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.4 | Root Contexts | Разбиране и прилагане на root contexts | [Ръководство](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.9 | Уеб търсене | Прилагане на възможности за уеб търсене | [Ръководство](./05-AdvancedTopics/web-search-mcp/README.md) |
...
| 07 | Уроци от ранното приемане | Истории за реално прилагане | [Ръководство](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | Най-добри практики за MCP | Производителност, устойчивост на грешки, устойчивост | [Ръководство](./08-BestPractices/README.md) |
| 09 | MCP казуси | Примери за практическо прилагане | [Ръководство](./09-CaseStudy/README.md) |
...
| 11.8 | Семантично търсене | Прилагане на векторни вграждания с Azure OpenAI и pgvector | [Лаборатория 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.11 | Стратегии за деплоймент | Деплоймент с Docker, Azure Container Apps и съображения за мащабиране | [Лаборатория 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
## 🎯 Предпоставки за изучаване на MCP
...
- (По избор) Основи в AI/ML концепции
...
Пригответе се за два дни на задълбочени технически прозрения, връзка
...
Практически, контекстуално ориентирани работни процеси за разработка
Сесии, водени от общността, и ценни прозрения
...
Посветен е на създателите на MCP. Ще се задълбочим в стратегии за имплементация и най-добри практики за създаване на MCP сървъри и интегриране на MCP във вашите AI работни процеси.
...
Научете чрез интензивни видео сесии как да създавате MCP сървъри, да интегрирате с VS Code и да разгръщате професионално на Azure, базирано на съдържанието от MCP за начинаещи. Ще придобиете практически умения в технология, която вече се използва от големи компании.
...
Докато напредвате през модулите, помнете, че всеки експерт някога е бил начинаещ. Концепциите, които сега може да изглеждат сложни, ще станат естествени, когато ги практикувате и прилагате. Всяка малка стъпка води към мощни способности, които ще ви служат през цялата ви кариера като разработчик.
...
Ако имате обратна връзка за продукта или срещнете грешки при изграждането, посетете:
...
Процесът за принос е създаден да бъде приветлив и подкрепящ. Повечето приноси изискват Споразумение за лиценз за принос (CLA), но автоматизираните инструменти ще ви насочат през процеса гладко.
...
Този проект приветства приноси и предложения. Повечето приноси изискват от вас да се съгласите със Споразумение за лиценз за принос (CLA), което декларира, че имате право и действително предоставяте права за използване на вашия принос. За подробности посетете <https://cla.opensource.microsoft.com>.
...
- [**НОВО** Edge AI For Beginners](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
