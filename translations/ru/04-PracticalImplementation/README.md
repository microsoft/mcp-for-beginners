...
[![Как создавать, тестировать и развертывать приложения MCP с использованием реальных инструментов и рабочих процессов](../../../translated_images/ru/05.64bea204e25ca891.png)](https://youtu.be/vCN9-mKBDfQ)
...
1. В **новом окне терминала** установите и запустите MCP Inspector
    ...
    ![Подключение к Node inspector](../../../translated_images/ru/connect.141db0b2bd05f096.png)
