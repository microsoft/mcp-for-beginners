...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T16:29:32+00:00",
...
Добро пожаловать в ваше путешествие по протоколу контекста модели! Если вы когда-либо задавались вопросом, как приложения ИИ взаимодействуют с различными инструментами и сервисами, вы скоро узнаете о элегантном решении, которое меняет подход к разработке интеллектуальных систем.

Представьте MCP как универсальный переводчик для приложений ИИ — как USB-порты позволяют подключать любое устройство к компьютеру, так MCP позволяет моделям ИИ подключаться к любым инструментам или сервисам в стандартизированном формате. Независимо от того, создаете ли вы свой первый чат-бот или работаете над сложными рабочими процессами ИИ, понимание MCP даст вам возможность создавать более мощные и гибкие приложения.

Этот учебный курс разработан с заботой о вашем обучении. Мы начнем с простых концепций, которые вам уже знакомы, и постепенно будем углублять ваши знания через практические занятия на вашем любимом языке программирования. Каждый шаг включает четкие объяснения, практические примеры и множество поддержки на пути.

К моменту завершения этого курса вы будете уверенно создавать свои собственные MCP-серверы, интегрировать их с популярными платформами ИИ и понимать, как эта технология меняет будущее разработки приложений ИИ. Давайте начнем это увлекательное приключение вместе!
...
- 📜 [Спецификация MCP](https://modelcontextprotocol.io/docs/) – Считайте это вашим подробным справочником. По мере прохождения курса вы будете возвращаться сюда, чтобы уточнить детали и изучить расширенные функции.
- 📜 [Оригинальная спецификация MCP](https://spec.modelcontextprotocol.io/) – Здесь содержатся дополнительные технические детали, которые могут быть полезны для сложных реализаций. Она доступна, когда вам это нужно, но не беспокойтесь о ней на начальном этапе.
- 🧑‍💻 [Репозиторий MCP на GitHub](https://github.com/modelcontextprotocol) – Здесь вы найдете SDK, инструменты и примеры кода на различных языках программирования. Это настоящий кладезь практических примеров и готовых компонентов.
...
К концу этого курса вы будете уверены в своих новых навыках и вдохновлены. Вот что вы достигнете:

• **Понимание основ MCP**: Вы поймете, что такое протокол контекста модели и почему он революционизирует взаимодействие приложений ИИ, используя понятные аналогии и примеры.
...
• **Подключение моделей ИИ к реальным инструментам**: Вы научитесь соединять модели ИИ с реальными сервисами, предоставляя вашим приложениям новые мощные возможности.
...
• **Присоединение к сообществу MCP**: Вы станете частью растущего сообщества разработчиков, которые формируют будущее разработки приложений ИИ.

## Основы, необходимые для начала

Прежде чем углубляться в специфику MCP, убедимся, что вы чувствуете себя комфортно с некоторыми базовыми концепциями. Не переживайте, если вы не эксперт в этих областях — мы объясним все, что вам нужно знать!

### Понимание протоколов (основа)

Представьте протокол как правила для разговора. Когда вы звоните другу, вы оба знаете, что нужно сказать "привет" при ответе, говорить по очереди и попрощаться, когда разговор окончен. Программам также нужны подобные правила для эффективного общения.

MCP — это протокол, набор согласованных правил, которые помогают моделям ИИ и приложениям вести продуктивные "разговоры" с инструментами и сервисами. Как правила общения делают человеческую коммуникацию более гладкой, так MCP делает взаимодействие приложений ИИ более надежным и мощным.

### Отношения клиент-сервер (как программы работают вместе)

Вы уже ежедневно используете отношения клиент-сервер! Когда вы используете веб-браузер (клиент) для посещения сайта, вы подключаетесь к веб-серверу, который отправляет вам содержимое страницы. Браузер знает, как запросить информацию, а сервер знает, как ответить.

В MCP у нас есть похожие отношения: модели ИИ выступают в роли клиентов, которые запрашивают информацию или действия, а MCP-серверы предоставляют эти возможности. Это как иметь полезного помощника (сервер), которому ИИ может поручить выполнение определенных задач.

### Почему стандартизация важна (чтобы все работало вместе)

Представьте, что каждый производитель автомобилей использует разные формы бензоколонок — вам понадобился бы отдельный адаптер для каждой машины! Стандартизация означает согласование общих подходов, чтобы все работало вместе без проблем.

MCP обеспечивает такую стандартизацию для приложений ИИ. Вместо того чтобы каждая модель ИИ нуждалась в индивидуальном коде для работы с каждым инструментом, MCP создает универсальный способ их взаимодействия. Это позволяет разработчикам создавать инструменты один раз и использовать их с множеством различных систем ИИ.

## 🧭 Обзор вашего пути обучения

Ваше путешествие по MCP тщательно структурировано, чтобы постепенно развивать вашу уверенность и навыки. Каждая фаза вводит новые концепции, укрепляя уже изученные.

### 🌱 Фаза основ: понимание базовых принципов (Модули 0-2)
...
• **Модуль 0 - Введение в MCP**: Мы начнем с изучения того, что такое MCP и почему он так важен для современных приложений ИИ. Вы увидите примеры использования MCP в реальной жизни и поймете, как он решает распространенные проблемы разработчиков.

• **Модуль 1 - Объяснение основных концепций**: Здесь вы изучите основные строительные блоки MCP. Мы будем использовать множество аналогий и визуальных примеров, чтобы эти концепции были понятны и естественны.
...
Этот модуль включает несколько практических руководств, которые позволят вам практиковаться на вашем любимом языке программирования. Вы создадите свой первый сервер, разработаете клиент для подключения к нему и даже интегрируете с популярными инструментами разработки, такими как VS Code.

Каждое руководство включает полный код, советы по устранению неполадок и объяснения, почему мы делаем определенные выборы в дизайне. К концу этой фазы у вас будут работающие реализации MCP, которыми вы сможете гордиться!

### 🚀 Фаза роста: углубленные концепции и применение в реальном мире (Модули 4-5)

Освоив основы, вы готовы изучить более сложные функции MCP. Мы рассмотрим практические стратегии реализации, методы отладки и углубленные темы, такие как интеграция мультимодального ИИ.

Вы также узнаете, как масштабировать свои реализации MCP для использования в производстве и интегрировать их с облачными платформами, такими как Azure. Эти модули подготовят вас к созданию решений MCP, которые могут справляться с реальными задачами.
...
| 3.10 | Расширенное использование серверов | Использование серверов для сложных функций и улучшенной архитектуры | [Руководство](./03-GettingStarted/10-advanced/README.md) |
...
| 11.2 | Основная архитектура | Понимание архитектуры серверов MCP, уровней баз данных и схем безопасности | [Лаборатория 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.7 | Разработка инструментов | Создание инструментов запросов к базе данных и анализа схемы | [Лаборатория 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
- Присоединение к обсуждениям сообщества для получения поддержки
...
Доступно подробное [Руководство по обучению](./study_guide.md), которое поможет вам эффективно ориентироваться в этом репозитории. Визуальная карта учебной программы показывает, как все темы связаны между собой, и дает рекомендации по использованию примеров проектов. Это особенно полезно, если вы визуал и предпочитаете видеть общую картину.
...
Мы ведем подробный [Журнал изменений](./changelog.md), который отслеживает все значительные обновления материалов учебной программы, чтобы вы могли быть в курсе последних улучшений и дополнений.
...
### MCP Boot Camp август 2025 года  
Узнайте в интенсивных видеосессиях, как создавать серверы MCP, интегрировать их с VS Code и профессионально развертывать на Azure, основываясь на учебной программе MCP для начинающих. Получите практические навыки в технологии, которую уже используют крупные компании.
...
### Давайте изучим MCP с C# - серия уроков  
Познакомьтесь с Model Context Protocol (MCP), передовой платформой, разработанной для стандартизации взаимодействий между моделями ИИ и клиентскими приложениями. В этом доступном для начинающих занятии мы познакомим вас с MCP и покажем, как создать ваш первый сервер MCP.  
...
Прочитав это введение, вы уже начали формировать базу знаний о MCP. Вы понимаете, что такое MCP, почему это важно, и как эта учебная программа поддержит ваше обучение. Это значительное достижение и начало вашего пути к освоению этой важной технологии.
...
Вы присоединяетесь к сообществу учащихся и экспертов, которые увлечены MCP и готовы помочь другим добиться успеха. Если вы столкнулись с трудностями или хотите поделиться своим прорывом, сообщество здесь, чтобы поддержать вас.
...
Ваше приключение с MCP начинается сейчас! Начните с Модуля 0, чтобы погрузиться в первые практические занятия с MCP, или изучите примеры проектов, чтобы увидеть, что вы будете создавать. Помните - каждый эксперт начинал именно там, где вы сейчас, и с терпением и практикой вы будете поражены своими достижениями.
...
Эта учебная программа становится лучше благодаря вкладу таких учащихся, как вы! Независимо от того, исправляете ли вы опечатку, предлагаете более ясное объяснение или добавляете новый пример, ваш вклад помогает другим новичкам добиться успеха.

Спасибо Microsoft Valued Professional [Шиваму Гойалу](https://www.linkedin.com/in/shivam2003/) за предоставленные примеры кода.
...
Когда вы отправляете pull request, бот CLA автоматически определяет, нужно ли вам предоставить CLA, и соответствующим образом оформляет PR (например, проверка статуса, комментарий). Просто следуйте инструкциям, предоставленным ботом. Вам нужно будет сделать это только один раз для всех репозиториев, использующих наш CLA.
...
- [Агенты ИИ для начинающих](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)  
