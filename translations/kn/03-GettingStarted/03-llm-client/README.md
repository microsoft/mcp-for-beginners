...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T19:36:02+00:00",
...
ಇದುವರೆಗೆ, ನೀವು ಸರ್ವರ್ ಮತ್ತು ಕ್ಲೈಂಟ್ ಅನ್ನು ಹೇಗೆ ರಚಿಸುವುದನ್ನು ನೋಡಿದ್ದೀರಿ. ಕ್ಲೈಂಟ್ ಸರ್ವರ್ ಅನ್ನು ಸ್ಪಷ್ಟವಾಗಿ ಕರೆಮಾಡಿ ಅದರ ಉಪಕರಣಗಳು, ಸಂಪನ್ಮೂಲಗಳು ಮತ್ತು ಪ್ರಾಂಪ್ಟ್‌ಗಳನ್ನು ಪಟ್ಟಿ ಮಾಡಬಹುದು. ಆದಾಗ್ಯೂ, ಇದು ಬಹಳ ಪ್ರಾಯೋಗಿಕ ವಿಧಾನವಲ್ಲ. ನಿಮ್ಮ ಬಳಕೆದಾರರು ಏಜೆಂಟಿಕ್ ಯುಗದಲ್ಲಿ ವಾಸಿಸುತ್ತಿದ್ದಾರೆ ಮತ್ತು ಪ್ರಾಂಪ್ಟ್‌ಗಳನ್ನು ಬಳಸಲು ಮತ್ತು LLM ಜೊತೆಗೆ ಸಂವಹನ ಮಾಡಲು ನಿರೀಕ್ಷಿಸುತ್ತಾರೆ. ನಿಮ್ಮ ಬಳಕೆದಾರರಿಗೆ ನೀವು MCP ಬಳಸುತ್ತೀರಾ ಅಥವಾ ಇಲ್ಲವೇ ಎಂಬುದಕ್ಕೆ ತಾಳ್ಮೆ ಇಲ್ಲ, ಆದರೆ ಅವರು ಸಹಜ ಭಾಷೆಯನ್ನು ಬಳಸಿಕೊಂಡು ಸಂವಹನ ಮಾಡಲು ನಿರೀಕ್ಷಿಸುತ್ತಾರೆ. ಹಾಗಾದರೆ ನಾವು ಇದನ್ನು ಹೇಗೆ ಪರಿಹರಿಸಬಹುದು? ಪರಿಹಾರವೆಂದರೆ ಕ್ಲೈಂಟ್‌ಗೆ LLM ಅನ್ನು ಸೇರಿಸುವುದು.
...
- LLM ಜೊತೆಗೆ ಕ್ಲೈಂಟ್ ರಚಿಸುವುದು.
- LLM ಬಳಸಿ MCP ಸರ್ವರ್ ಜೊತೆಗೆ ನಿರಂತರವಾಗಿ ಸಂವಹನ ಮಾಡುವುದು.
...
- `client` ಮತ್ತು `openai` ಎಂಬ ಎರಡು ಸದಸ್ಯರೊಂದಿಗೆ ಕ್ಲಾಸ್ ರಚಿಸಿದ್ದೇವೆ, ಇದು ಕ್ರಮವಾಗಿ ಕ್ಲೈಂಟ್ ನಿರ್ವಹಣೆ ಮತ್ತು LLM ಜೊತೆಗೆ ಸಂವಹನ ಮಾಡಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ.
- GitHub Models ಬಳಸಲು ನಮ್ಮ LLM ಉದಾಹರಣೆಯನ್ನು `baseUrl` ಅನ್ನು ಇನ್ಫರೆನ್ಸ್ API ಗೆ ಸೂಚಿಸುವಂತೆ ಸಂರಚಿಸಿದ್ದೇವೆ.
...
- **HTTP ಸಾರಿಗೆ ವ್ಯವಸ್ಥೆ ಸ್ಥಾಪಿಸಿದ್ದೇವೆ**: MCP ಸರ್ವರ್‌ಗೆ ಸಂಪರ್ಕಿಸಲು Server-Sent Events (SSE) ಬಳಸಿ
...
ಈ ಉದಾಹರಣೆ ನಿಮ್ಮ ಬಳಿ Rust ಆಧಾರಿತ MCP ಸರ್ವರ್ ಇದ್ದರೆ ಎಂದು ಊಹಿಸುತ್ತದೆ. ಇಲ್ಲದಿದ್ದರೆ, ಸರ್ವರ್ ರಚಿಸಲು [01-first-server](../01-first-server/README.md) ಪಾಠಕ್ಕೆ ಹಿಂತಿರುಗಿ.
...
ಈ ಕೋಡ್ ಮೂಲಭೂತ Rust ಅಪ್ಲಿಕೇಶನ್ ಅನ್ನು ಸ್ಥಾಪಿಸುತ್ತದೆ, ಇದು MCP ಸರ್ವರ್ ಮತ್ತು GitHub Models ಗೆ LLM ಸಂವಹನಕ್ಕಾಗಿ ಸಂಪರ್ಕಿಸುತ್ತದೆ.
...
- ನಮ್ಮ ಅಪ್ಲಿಕೇಶನ್ ಫ್ಲೋ ನಿರ್ವಹಿಸುವ `run` ವಿಧಾನ ರಚಿಸಿದ್ದೇವೆ. ಇದುವರೆಗೆ ಇದು ಉಪಕರಣಗಳನ್ನು ಮಾತ್ರ ಪಟ್ಟಿ ಮಾಡುತ್ತದೆ, ಆದರೆ ನಾವು ಅದಕ್ಕೆ ಇನ್ನಷ್ಟು ಸೇರಿಸುವೆವು.
...
- ಸಂಪನ್ಮೂಲಗಳು ಮತ್ತು ಉಪಕರಣಗಳನ್ನು ಪಟ್ಟಿ ಮಾಡಿ ಮುದ್ರಿಸಿದ್ದೇವೆ. ಉಪಕರಣಗಳಿಗಾಗಿ ನಾವು ನಂತರ ಬಳಸುವ `inputSchema` ಕೂಡ ಪಟ್ಟಿ ಮಾಡಿದ್ದೇವೆ.
...
- ಪ್ರತಿ ಉಪಕರಣದ ಹೆಸರು, ವಿವರಣೆ ಮತ್ತು ಅದರ ಸ್ಕೀಮಾವನ್ನು ಪಟ್ಟಿ ಮಾಡಿದ್ದೇವೆ. ಇದನ್ನು ನಾವು ಶೀಘ್ರದಲ್ಲೇ ಉಪಕರಣಗಳನ್ನು ಕರೆಮಾಡಲು ಬಳಸುತ್ತೇವೆ.
...
// MCP ಸಾಧನ ಪೂರೈಕೆದಾರನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ನಿರ್ವಹಿಸುತ್ತದೆ:
...
- MCP ಸರ್ವರ್‌ನಿಂದ ಎಲ್ಲಾ ಉಪಕರಣಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಕಂಡುಹಿಡಿದು ನೋಂದಾಯಿಸುವ `McpToolProvider` ರಚಿಸಿದ್ದೇವೆ
- ಉಪಕರಣದ ಸ್ಕೀಮಾ ಮತ್ತು LangChain4j ಉಪಕರಣ ಸ್ವರೂಪದ ನಡುವಿನ ಪರಿವರ್ತನೆಯನ್ನು ಟೂಲ್ ಪ್ರೊವೈಡರ್ ಒಳಗೆ ನಿರ್ವಹಿಸುತ್ತದೆ
- ಈ ವಿಧಾನವು ಕೈಯಿಂದ ಉಪಕರಣ ಪಟ್ಟಿ ಮತ್ತು ಪರಿವರ್ತನೆ ಪ್ರಕ್ರಿಯೆಯನ್ನು ಅಡಗಿಸುತ್ತದೆ

#### Rust

MCP ಸರ್ವರ್‌ನಿಂದ ಉಪಕರಣಗಳನ್ನು ಪಡೆಯಲು `list_tools` ವಿಧಾನವನ್ನು ಬಳಸಲಾಗುತ್ತದೆ. ನಿಮ್ಮ `main` ಫಂಕ್ಷನ್‌ನಲ್ಲಿ MCP ಕ್ಲೈಂಟ್ ಸ್ಥಾಪಿಸಿದ ನಂತರ ಕೆಳಗಿನ ಕೋಡ್ ಸೇರಿಸಿ:
...
### -3- ಸರ್ವರ್ ಸಾಮರ್ಥ್ಯಗಳನ್ನು LLM ಉಪಕರಣಗಳಾಗಿ ಪರಿವರ್ತಿಸುವುದು

ಸರ್ವರ್ ಸಾಮರ್ಥ್ಯಗಳನ್ನು ಪಟ್ಟಿ ಮಾಡಿದ ನಂತರದ ಹಂತವೆಂದರೆ ಅವುಗಳನ್ನು LLM ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಸ್ವರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸುವುದು. ಇದಾದ ಮೇಲೆ, ನಾವು ಈ ಸಾಮರ್ಥ್ಯಗಳನ್ನು LLM ಗೆ ಉಪಕರಣಗಳಾಗಿ ಒದಗಿಸಬಹುದು.

#### TypeScript

1. MCP ಸರ್ವರ್‌ನ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು LLM ಬಳಸಬಹುದಾದ ಉಪಕರಣ ಸ್ವರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸಲು ಕೆಳಗಿನ ಕೋಡ್ ಸೇರಿಸಿ:
    ...
    ಮೇಲಿನ ಕೋಡ್ MCP ಸರ್ವರ್‌ನ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ತೆಗೆದು ಅದನ್ನು LLM ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಉಪಕರಣ ವ್ಯಾಖ್ಯಾನ ಸ್ವರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸುತ್ತದೆ.
...
1. ಮೊದಲು, ಕೆಳಗಿನ ಪರಿವರ್ತಕ ಫಂಕ್ಷನ್ ರಚಿಸೋಣ
    ...
    ಮೇಲಿನ `convert_to_llm_tools` ಫಂಕ್ಷನ್‌ನಲ್ಲಿ ನಾವು MCP ಉಪಕರಣ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ತೆಗೆದು LLM ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಸ್ವರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸುತ್ತೇವೆ.
...
1. ನಂತರ, ಈ ಫಂಕ್ಷನ್ ಅನ್ನು ಬಳಸಲು ನಮ್ಮ ಕ್ಲೈಂಟ್ ಕೋಡ್ ನವೀಕರಿಸೋಣ:
    ...
    ಇಲ್ಲಿ, ನಾವು MCP ಉಪಕರಣ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು LLM ಗೆ ನೀಡಲು `convert_to_llm_tool` ಕರೆ ಸೇರಿಸಿದ್ದೇವೆ.
...
- ಇದು `FunctionDefinition` ರಚಿಸುವ ಕಾರ್ಯಕ್ಷಮತೆಯನ್ನು ಹೊಂದಿದೆ, ಇದು `ChatCompletionsDefinition` ಗೆ ಪಾಸ್ ಆಗುತ್ತದೆ. ಇದು LLM ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಸ್ವರೂಪ.

1. ಈ ಫಂಕ್ಷನ್ ಉಪಯೋಗಿಸಲು ಕೆಲವು ಇತ್ತೀಚಿನ ಕೋಡ್ ನವೀಕರಿಸುವುದನ್ನು ನೋಡೋಣ:
...
- ಸಹಜ ಭಾಷೆ ಸಂವಹನಕ್ಕಾಗಿ ಸರಳ `Bot` ಇಂಟರ್ಫೇಸ್ ವ್ಯಾಖ್ಯಾನಿಸಿದ್ದೇವೆ
- LangChain4j ನ `AiServices` ಬಳಸಿ LLM ಮತ್ತು MCP ಟೂಲ್ ಪ್ರೊವೈಡರ್ ಅನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಬಂಧಿಸಿದ್ದೇವೆ
- ಫ್ರೇಮ್ವರ್ಕ್ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಟೂಲ್ ಸ್ಕೀಮಾ ಪರಿವರ್ತನೆ ಮತ್ತು ಫಂಕ್ಷನ್ ಕರೆಗಳನ್ನು ಹಿಂಬಾಲಿಸುತ್ತದೆ
- ಈ ವಿಧಾನ ಕೈಯಿಂದ ಟೂಲ್ ಪರಿವರ್ತನೆಯನ್ನು ತೆಗೆದುಹಾಕುತ್ತದೆ - LangChain4j MCP ಟೂಲ್‌ಗಳನ್ನು LLM-ಸಂಗತ ಸ್ವರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸುವ ಎಲ್ಲಾ ಸಂಕೀರ್ಣತೆಯನ್ನು ನಿರ್ವಹಿಸುತ್ತದೆ

#### Rust

MCP ಉಪಕರಣ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು LLM ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಸ್ವರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸಲು, ನಾವು ಉಪಕರಣಗಳ ಪಟ್ಟಿ ಸ್ವರೂಪಗೊಳಿಸುವ ಸಹಾಯಕ ಫಂಕ್ಷನ್ ಸೇರಿಸುವೆವು. ನಿಮ್ಮ `main.rs` ಫೈಲ್‌ನಲ್ಲಿ `main` ಫಂಕ್ಷನ್ ಕೆಳಗೆ ಕೆಳಗಿನ ಕೋಡ್ ಸೇರಿಸಿ. ಇದು LLM ಗೆ ವಿನಂತಿ ಮಾಡುವಾಗ ಕರೆಮಾಡಲಾಗುತ್ತದೆ:
...
ಚೆನ್ನಾಗಿದೆ, ನಾವು ಬಳಕೆದಾರರ ವಿನಂತಿಗಳನ್ನು ನಿರ್ವಹಿಸಲು ಸಿದ್ಧರಾಗಿಲ್ಲ, ಆದ್ದರಿಂದ ಅದನ್ನು ಮುಂದಿನ ಹಂತದಲ್ಲಿ ನೋಡೋಣ.

### -4- ಬಳಕೆದಾರರ ಪ್ರಾಂಪ್ಟ್ ವಿನಂತಿಯನ್ನು ನಿರ್ವಹಿಸುವುದು

ಈ ಭಾಗದಲ್ಲಿ, ನಾವು ಬಳಕೆದಾರರ ವಿನಂತಿಗಳನ್ನು ನಿರ್ವಹಿಸುವೆವು.
...
1. ನಮ್ಮ LLM ಅನ್ನು ಕರೆಮಾಡಲು ಬಳಸುವ ವಿಧಾನ ಸೇರಿಸೋಣ:
    ...
    - ಈ ವಿಧಾನ LLM ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ತೆಗೆದು ಯಾವ ಉಪಕರಣಗಳನ್ನು ಕರೆಮಾಡಲಾಗಿದೆ ಎಂದು ಪರಿಶೀಲಿಸುತ್ತದೆ:
    ...
    - LLM ಸೂಚಿಸಿದರೆ ಉಪಕರಣವನ್ನು ಕರೆಮಾಡುತ್ತದೆ:
...
ಚೆನ್ನಾಗಿದೆ, ಸಂಪೂರ್ಣ ಕೋಡ್ ಅನ್ನು ಪಟ್ಟಿ ಮಾಡೋಣ:
...
class MyClient {
    ...
    async run() {
        ...
        // 1. LLM ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ಪರಿಶೀಲಿಸಿ, ಪ್ರತಿ ಆಯ್ಕೆಗೆ ಉಪಕರಣ ಕರೆಗಳಿವೆ ಎಂದು ಪರಿಶೀಲಿಸಿ
        (await response).choices.map(async (choice: { message: any; }) => {
          const message = choice.message;
          if (message.tool_calls) {
              console.log("Making tool call")
...
1. ಕೊನೆಯ ಹಂತ, ನಮ್ಮ ಮುಖ್ಯ ಕೋಡ್ ನವೀಕರಿಸೋಣ:
    ...
    # ಎಲ್ಲಕ್ಕೆ ಯಾವ ಉಪಕರಣಗಳನ್ನು ಕೇಳಿ, ಇದ್ದರೆ
    functions_to_call = call_llm(prompt, functions)

    # ಸೂಚಿಸಿದ ಕಾರ್ಯಗಳನ್ನು ಕರೆ ಮಾಡಿ
    ...
    - LLM ಪ್ರಾಂಪ್ಟ್ ಆಧಾರಿತವಾಗಿ ಕರೆಮಾಡಬೇಕಾದ MCP ಉಪಕರಣವನ್ನು `call_tool` ಮೂಲಕ ಕರೆಮಾಡುತ್ತಿದ್ದೇವೆ.
    - ಉಪಕರಣದ ಕರೆ ಫಲಿತಾಂಶವನ್ನು MCP ಸರ್ವರ್‌ಗೆ ಮುದ್ರಿಸುತ್ತಿದ್ದೇವೆ.
...
1. LLM ಪ್ರಾಂಪ್ಟ್ ವಿನಂತಿಗಾಗಿ ಕೆಲವು ಕೋಡ್ ತೋರಿಸೋಣ:
    ...
    - ಬಳಕೆದಾರರ ಪ್ರಾಂಪ್ಟ್ `userMessage` ಅನ್ನು ವ್ಯಾಖ್ಯಾನಿಸಿದ್ದೇವೆ.
    - ಮಾದರಿ ಮತ್ತು ಉಪಕರಣಗಳನ್ನು ಸೂಚಿಸುವ ಆಯ್ಕೆಗಳು ಹೊಂದಿರುವ ವಸ್ತುವನ್ನು ರಚಿಸಿದ್ದೇವೆ.
    - LLM ಗೆ ವಿನಂತಿ ಮಾಡಿದ್ದೇವೆ.

1. ಕೊನೆಯ ಹಂತ, LLM ಫಂಕ್ಷನ್ ಕರೆ ಮಾಡಬೇಕೆಂದು ಭಾವಿಸಿದರೆ ನೋಡೋಣ:
    ...
    - ಪ್ರತಿ ಉಪಕರಣ ಕರೆಗಾಗಿ, ಹೆಸರು ಮತ್ತು ಆರ್ಗ್ಯುಮೆಂಟ್‌ಗಳನ್ನು ಪಾರ್ಸ್ ಮಾಡಿ MCP ಕ್ಲೈಂಟ್ ಬಳಸಿ MCP ಸರ್ವರ್‌ನಲ್ಲಿ ಉಪಕರಣವನ್ನು ಕರೆಮಾಡುತ್ತೇವೆ. ಕೊನೆಗೆ ಫಲಿತಾಂಶವನ್ನು ಮುದ್ರಿಸುತ್ತೇವೆ.
...
- ಸರಳ ಸಹಜ ಭಾಷೆ ಪ್ರಾಂಪ್ಟ್‌ಗಳನ್ನು ಬಳಸಿ MCP ಸರ್ವರ್ ಉಪಕರಣಗಳೊಂದಿಗೆ ಸಂವಹನ ಮಾಡಿದ್ದೇವೆ
- LangChain4j ಫ್ರೇಮ್ವರ್ಕ್ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ನಿರ್ವಹಿಸುತ್ತದೆ:
  - ಅಗತ್ಯವಿದ್ದಾಗ ಬಳಕೆದಾರರ ಪ್ರಾಂಪ್ಟ್‌ಗಳನ್ನು ಉಪಕರಣ ಕರೆಗಳಿಗೆ ಪರಿವರ್ತಿಸುವುದು
  - LLM ನಿರ್ಧಾರ ಆಧಾರಿತವಾಗಿ ಸೂಕ್ತ MCP ಉಪಕರಣಗಳನ್ನು ಕರೆಮಾಡುವುದು
  - LLM ಮತ್ತು MCP ಸರ್ವರ್ ನಡುವಿನ ಸಂಭಾಷಣಾ ಹರಿವನ್ನು ನಿರ್ವಹಿಸುವುದು
- `bot.chat()` ವಿಧಾನ ಸಹಜ ಭಾಷೆ ಪ್ರತಿಕ್ರಿಯೆಗಳನ್ನು ನೀಡುತ್ತದೆ, ಇದರಲ್ಲಿ MCP ಉಪಕರಣ ಕಾರ್ಯಾಚರಣೆ ಫಲಿತಾಂಶಗಳು ಸೇರಿರಬಹುದು
- ಈ ವಿಧಾನ ಬಳಕೆದಾರರಿಗೆ MCP ಅಡಿಯಲ್ಲಿ ಇರುವ ಜಟಿಲತೆಯನ್ನು ತಿಳಿಯಬೇಕಾಗಿಲ್ಲದಂತೆ ಸೌಕರ್ಯವನ್ನು ಒದಗಿಸುತ್ತದೆ
...
ಇಲ್ಲಿ ಬಹುಮತ ಕೆಲಸ ನಡೆಯುತ್ತದೆ. ನಾವು ಪ್ರಾಥಮಿಕ ಬಳಕೆದಾರರ ಪ್ರಾಂಪ್ಟ್ ಜೊತೆಗೆ LLM ಅನ್ನು ಕರೆಮಾಡುತ್ತೇವೆ, ನಂತರ ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ಪ್ರಕ್ರಿಯೆ ಮಾಡಿ ಯಾವ ಉಪಕರಣಗಳನ್ನು ಕರೆಮಾಡಬೇಕೋ ನೋಡುತ್ತೇವೆ. ಅಗತ್ಯವಿದ್ದರೆ, ಆ ಉಪಕರಣಗಳನ್ನು ಕರೆಮಾಡಿ LLM ಜೊತೆಗೆ ಸಂಭಾಷಣೆಯನ್ನು ಮುಂದುವರಿಸುತ್ತೇವೆ, ಇನ್ನಷ್ಟು ಉಪಕರಣ ಕರೆಗಳ ಅಗತ್ಯವಿಲ್ಲದವರೆಗೆ ಮತ್ತು ಅಂತಿಮ ಪ್ರತಿಕ್ರಿಯೆ ಸಿಗುವವರೆಗೆ.

ನಾವು LLM ಗೆ ಅನೇಕ ಬಾರಿ ಕರೆಮಾಡಲಿದ್ದೇವೆ, ಆದ್ದರಿಂದ LLM ಕರೆ ನಿರ್ವಹಿಸುವ ಫಂಕ್ಷನ್ ಅನ್ನು ವ್ಯಾಖ್ಯಾನಿಸೋಣ. ನಿಮ್ಮ `main.rs` ಫೈಲ್‌ಗೆ ಕೆಳಗಿನ ಫಂಕ್ಷನ್ ಸೇರಿಸಿ:
...
ಈ ಫಂಕ್ಷನ್ LLM ಕ್ಲೈಂಟ್, ಸಂದೇಶಗಳ ಪಟ್ಟಿ (ಬಳಕೆದಾರರ ಪ್ರಾಂಪ್ಟ್ ಸೇರಿ), MCP ಸರ್ವರ್‌ನಿಂದ ಉಪಕರಣಗಳು ತೆಗೆದು LLM ಗೆ ವಿನಂತಿ ಕಳುಹಿಸಿ, ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ಹಿಂತಿರುಗಿಸುತ್ತದೆ.
...
`tool_calls` ಇದ್ದರೆ, ಅದು ಸಾಧನ ಮಾಹಿತಿಯನ್ನು ತೆಗೆದು, MCP ಸರ್ವರ್‌ಗೆ ಸಾಧನ ವಿನಂತಿಯನ್ನು ಕರೆದೊಯ್ಯುತ್ತದೆ ಮತ್ತು ಫಲಿತಾಂಶಗಳನ್ನು ಸಂಭಾಷಣೆ ಸಂದೇಶಗಳಿಗೆ ಸೇರಿಸುತ್ತದೆ. ನಂತರ LLM ಜೊತೆಗೆ ಸಂಭಾಷಣೆಯನ್ನು ಮುಂದುವರೆಸುತ್ತದೆ ಮತ್ತು ಸಂದೇಶಗಳು ಸಹಾಯಕನ ಪ್ರತಿಕ್ರಿಯೆ ಮತ್ತು ಸಾಧನ ಕರೆ ಫಲಿತಾಂಶಗಳೊಂದಿಗೆ ನವೀಕರಿಸಲಾಗುತ್ತದೆ.
