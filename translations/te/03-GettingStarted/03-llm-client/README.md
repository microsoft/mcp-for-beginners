...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T18:57:01+00:00",
...
ఇప్పటివరకు, మీరు సర్వర్ మరియు క్లయింట్‌ను ఎలా సృష్టించాలో చూశారు. క్లయింట్ సర్వర్‌ను స్పష్టంగా పిలిచి దాని టూల్స్, వనరులు మరియు ప్రాంప్ట్‌లను జాబితా చేయగలిగింది. అయితే, ఇది చాలా ప్రాక్టికల్ విధానం కాదు. మీ యూజర్ ఏజెంటిక్ యుగంలో జీవిస్తున్నారు మరియు ప్రాంప్ట్‌లను ఉపయోగించి LLMతో కమ్యూనికేట్ చేయాలని ఆశిస్తున్నారు. మీ యూజర్‌కు మీరు MCP ఉపయోగిస్తున్నారా లేదా అనేది పట్టించుకోదు, కానీ వారు సహజ భాషను ఉపయోగించి ఇంటరాక్ట్ చేయాలని ఆశిస్తున్నారు. కాబట్టి దీన్ని ఎలా పరిష్కరిస్తాం? పరిష్కారం క్లయింట్‌కు LLMను జోడించడం గురించి.

## అవలోకనం

ఈ పాఠంలో, మీ క్లయింట్‌కు LLMను జోడించడం మరియు ఇది మీ యూజర్‌కు ఎలా మెరుగైన అనుభవాన్ని అందిస్తుందో చూపించడంపై దృష్టి సారిస్తాము.
...
మనం తీసుకోవలసిన విధానాన్ని అర్థం చేసుకుందాం. LLMను జోడించడం సులభంగా అనిపించవచ్చు, కానీ నిజంగా మనం దీన్ని ఎలా చేస్తాం?
...
అద్భుతం, ఇప్పుడు మనం ఈ విధానాన్ని ఉన్నత స్థాయిలో అర్థం చేసుకున్నాము, కింద ఇచ్చిన వ్యాయామంలో దీన్ని ప్రయత్నిద్దాం.

## వ్యాయామం: LLMతో క్లయింట్ సృష్టించడం

ఈ వ్యాయామంలో, మనం మన క్లయింట్‌కు LLMను జోడించడం నేర్చుకుంటాము.
...
- మీ టోకెన్‌ను కాన్ఫిగర్ చేయండి – సూచన కోసం ఒక నోట్ జోడించండి, గడువు తేదీ సెట్ చేయండి, మరియు అవసరమైన స్కోప్స్ (అనుమతులు) ఎంచుకోండి. ఈ సందర్భంలో Models అనుమతిని జోడించండి.
...
- `client` మరియు `openai` అనే రెండు సభ్యులతో ఒక క్లాస్ సృష్టించాము, ఇవి మనకు క్లయింట్‌ను నిర్వహించడంలో మరియు LLMతో ఇంటరాక్ట్ చేయడంలో సహాయపడతాయి.
- మన LLM ఇన్స్టాన్స్‌ను GitHub Models ఉపయోగించడానికి `baseUrl`ని inference APIకి పాయింట్ చేయడం ద్వారా కాన్ఫిగర్ చేసాము.
...
> [!IMPORTANT]
> అప్లికేషన్ నడపడానికి ముందు మీ GitHub టోకెన్‌తో `OPENAI_API_KEY` ఎన్విరాన్‌మెంట్ వేరియబుల్ సెట్ చేయండి.

అద్భుతం, తదుపరి దశకు, సర్వర్‌పై సామర్థ్యాలను జాబితా చేద్దాం.

### -2- సర్వర్ సామర్థ్యాలను జాబితా చేయండి

ఇప్పుడు మనం సర్వర్‌కు కనెక్ట్ అవ్వబోతున్నాము మరియు దాని సామర్థ్యాలను అడుగుతాము:
...
- మన యాప్ ఫ్లో నిర్వహించడానికి `run` మెథడ్ సృష్టించాము. ఇప్పటివరకు ఇది కేవలం టూల్స్ జాబితా చేస్తుంది, కానీ త్వరలో మరిన్ని జోడిస్తాము.
...
- ప్రతి టూల్ కోసం పేరు, వివరణ మరియు దాని స్కీమాను జాబితా చేశాము. ఇది మనం త్వరలో టూల్స్ పిలవడానికి ఉపయోగించబోతున్నది.
...
సర్వర్ సామర్థ్యాలను జాబితా చేసిన తర్వాత తదుపరి దశ వాటిని LLM అర్థం చేసుకునే ఫార్మాట్‌గా మార్చడం. ఒకసారి మనం చేస్తే, ఈ సామర్థ్యాలను మన LLMకు టూల్స్‌గా అందించవచ్చు.
...
1. MCP సర్వర్ నుండి వచ్చిన ప్రతిస్పందనను LLM ఉపయోగించగల టూల్ ఫార్మాట్‌గా మార్చడానికి క్రింది కోడ్ జోడించండి:
    ...
    openAiToolAdapter(tool: {
        ...
        // ఇన్‌పుట్_స్కీమా ఆధారంగా ఒక జాడ్ స్కీమాను సృష్టించండి
...
1. తరువాత, సర్వర్ సామర్థ్యాలను జాబితా చేయడానికి `run` మెథడ్‌ను అప్‌డేట్ చేద్దాం:
    ...
    పూర్వపు కోడ్‌లో, `run` మెథడ్‌ను ఫలితంపై మ్యాప్ చేసి ప్రతి ఎంట్రీకి `openAiToolAdapter` పిలవడానికి అప్‌డేట్ చేసాము.
...
1. ముందుగా, క్రింది కన్వర్టర్ ఫంక్షన్ సృష్టిద్దాం
    ...
    పై ఫంక్షన్ `convert_to_llm_tools` లో MCP టూల్ ప్రతిస్పందనను LLM అర్థం చేసుకునే ఫార్మాట్‌గా మార్చుతాము.

1. తరువాత, మన క్లయింట్ కోడ్‌ను ఈ ఫంక్షన్ ఉపయోగించ도록 అప్‌డేట్ చేద్దాం:
    ...
    ఇక్కడ, MCP టూల్ ప్రతిస్పందనను LLMకి ఫీడ్ చేయడానికి `convert_to_llm_tool` పిలవడం జోడించాము.
...
- ఇది `FunctionDefinition` సృష్టించి `ChatCompletionsDefinition`కి పంపుతుంది. ఇది LLM అర్థం చేసుకునే ఫార్మాట్.

1. ఈ ఫంక్షన్ ఉపయోగించడానికి కొంత ఉన్న కోడ్ ఎలా అప్‌డేట్ చేయాలో చూద్దాం:
...
- ఫ్రేమ్‌వర్క్ టూల్ స్కీమా మార్పిడి మరియు ఫంక్షన్ కాలింగ్‌ను స్వయంచాలకంగా నిర్వహిస్తుంది
...
MCP టూల్ ప్రతిస్పందనను LLM అర్థం చేసుకునే ఫార్మాట్‌గా మార్చడానికి, టూల్స్ జాబితాను ఫార్మాట్ చేసే హెల్పర్ ఫంక్షన్ జోడిస్తాము. `main` ఫంక్షన్ కింద మీ `main.rs` ఫైల్‌లో క్రింది కోడ్ జోడించండి. ఇది LLMకు అభ్యర్థనలు చేసే సమయంలో పిలవబడుతుంది:
...
అద్భుతం, ఇప్పుడు మనం యూజర్ అభ్యర్థనలను హ్యాండిల్ చేయడానికి సెట్ అయ్యాము, కాబట్టి తదుపరి దశకు వెళ్లుదాం.

### -4- యూజర్ ప్రాంప్ట్ అభ్యర్థనను హ్యాండిల్ చేయండి

ఈ భాగంలో, మనం యూజర్ అభ్యర్థనలను హ్యాండిల్ చేస్తాము.

#### TypeScript

1. మన LLMను పిలవడానికి ఉపయోగించే మెథడ్ జోడించండి:
...
class MyClient {
    ...
    constructor(){
        this.openai = new OpenAI({
            baseURL: "https://models.inference.ai.azure.com", // భవిష్యత్తులో ఈ URL ను మార్చాల్సి ఉండవచ్చు: https://models.github.ai/inference
            apiKey: process.env.GITHUB_TOKEN,
        });
    ...
    async run() {
        ...
        // 1. LLM ప్రతిస్పందన ద్వారా వెళ్లండి, ప్రతి ఎంపిక కోసం, అది టూల్ కాల్స్ ఉన్నదో లేదో తనిఖీ చేయండి
        (await response).choices.map(async (choice: { message: any; }) => {
          const message = choice.message;
          if (message.tool_calls) {
              console.log("Making tool call")
...
1. చివరి దశ, మన ప్రధాన కోడ్‌ను అప్‌డేట్ చేద్దాం:
    ...
    - LLM సూచించిన ఫంక్షన్ ఆధారంగా MCP టూల్‌ను `call_tool` ద్వారా పిలవడం.
    - టూల్ కాల్ ఫలితాన్ని MCP సర్వర్‌కు ప్రింట్ చేయడం.
...
1. చివరి దశ, LLM ఫంక్షన్ కాల్ చేయాలని భావిస్తే చూద్దాం:
    ...
    - ప్రతి టూల్ కాల్ కోసం పేరు మరియు ఆర్గ్యుమెంట్స్ పార్స్ చేసి MCP క్లయింట్ ఉపయోగించి టూల్ పిలిచాము. చివరగా ఫలితాలు ప్రింట్ చేశాము.
...
- సింపుల్ సహజ భాష ప్రాంప్ట్‌లను ఉపయోగించి MCP సర్వర్ టూల్స్‌తో ఇంటరాక్ట్ చేశాము
...
- `bot.chat()` మెథడ్ సహజ భాష ప్రతిస్పందనలను ఇస్తుంది, వాటిలో MCP టూల్ ఎగ్జిక్యూషన్ ఫలితాలు ఉండవచ్చు
- ఈ విధానం యూజర్‌కు సజావుగా అనుభవాన్ని అందిస్తుంది, వారు MCP అమలు గురించి తెలుసుకోవాల్సిన అవసరం లేదు
...
ఇక్కడ ఎక్కువ భాగం పని జరుగుతుంది. మనం ప్రారంభ యూజర్ ప్రాంప్ట్‌తో LLMను పిలుస్తాము, ఆ తర్వాత ప్రతిస్పందనను ప్రాసెస్ చేసి ఏ టూల్స్ పిలవాల్సి ఉంటే పిలుస్తాము. ఆ తర్వాత LLMతో సంభాషణ కొనసాగించి మరింత టూల్ కాల్స్ అవసరం లేకుండా తుది ప్రతిస్పందన పొందుతాము.

మనము LLMకు అనేక కాల్స్ చేయబోతున్నాము, కాబట్టి LLM కాల్‌ను హ్యాండిల్ చేసే ఫంక్షన్ నిర్వచిద్దాం. క్రింది ఫంక్షన్‌ను మీ `main.rs` ఫైల్‌లో జోడించండి:
...
ఈ ఫంక్షన్ LLM క్లయింట్, సందేశాల జాబితా (యూజర్ ప్రాంప్ట్ సహా), MCP సర్వర్ నుండి టూల్స్ తీసుకుని LLMకు అభ్యర్థన పంపి ప్రతిస్పందనను తిరిగి ఇస్తుంది.
LLM నుండి వచ్చిన ప్రతిస్పందనలో `choices` అనే అర్రే ఉంటుంది. ఏమైనా `tool_calls` ఉన్నాయా అని ఫలితాన్ని ప్రాసెస్ చేయాల్సి ఉంటుంది. ఇది LLM ఒక నిర్దిష్ట టూల్‌ను ఆర్గ్యుమెంట్లతో పిలవాలని కోరుకుంటున్నట్లు మనకు తెలియజేస్తుంది. LLM ప్రతిస్పందనను హ్యాండిల్ చేయడానికి క్రింది కోడ్‌ను మీ `main.rs` ఫైల్ చివర చేర్చండి:
...
async fn process_llm_response(
    ...
    if let Some(tool_calls) = message.get("tool_calls").and_then(|tc| tc.as_array()) {
        messages.push(message.clone()); // అసిస్టెంట్ సందేశాన్ని జోడించండి
...
`tool_calls` ఉంటే, అది టూల్ సమాచారాన్ని తీసుకుని, టూల్ అభ్యర్థనతో MCP సర్వర్‌ను పిలుస్తుంది, మరియు ఫలితాలను సంభాషణ సందేశాలకు జోడిస్తుంది. తరువాత LLM తో సంభాషణ కొనసాగుతుంది మరియు సందేశాలు అసిస్టెంట్ ప్రతిస్పందన మరియు టూల్ కాల్ ఫలితాలతో నవీకరించబడతాయి.
...
అన్ని భాగాలు సిద్ధంగా ఉన్నందున, మేము ప్రారంభ యూజర్ ప్రాంప్ట్‌ను హ్యాండిల్ చేసి LLM ను పిలవవచ్చు. మీ `main` ఫంక్షన్‌ను క్రింది కోడ్‌తో నవీకరించండి:
...
ఇది ప్రారంభ యూజర్ ప్రాంప్ట్‌తో LLM ను ప్రశ్నిస్తుంది, రెండు సంఖ్యల మొత్తం అడుగుతుంది, మరియు ప్రతిస్పందనను ప్రాసెస్ చేసి డైనమిక్‌గా టూల్ కాల్స్‌ను హ్యాండిల్ చేస్తుంది.

చాలా బాగుంది, మీరు చేసారు!

## అసైన్‌మెంట్

వ్యాయామం నుండి కోడ్ తీసుకుని మరిన్ని టూల్స్‌తో సర్వర్‌ను నిర్మించండి. ఆపై LLM ఉన్న క్లయింట్‌ను సృష్టించి, వివిధ ప్రాంప్ట్‌లతో పరీక్షించండి, మీ సర్వర్ టూల్స్ డైనమిక్‌గా పిలవబడుతున్నాయా అని నిర్ధారించుకోండి. ఈ విధంగా క్లయింట్ నిర్మించడం ద్వారా, చివరి వినియోగదారుడు ఖచ్చితమైన క్లయింట్ కమాండ్ల బదులు ప్రాంప్ట్‌లను ఉపయోగించి గొప్ప వినియోగదారు అనుభవం పొందగలుగుతారు, మరియు ఏ MCP సర్వర్ పిలవబడుతున్నదో తెలియదు.
...
- మీ క్లయింట్‌కు LLM ను చేర్చడం MCP సర్వర్లతో వినియోగదారులు మెరుగైన మార్గంలో ఇంటరాక్ట్ అవ్వడానికి సహాయపడుతుంది.
