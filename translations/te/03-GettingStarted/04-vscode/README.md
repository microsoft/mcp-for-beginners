...
![Visual Studio Code లో గైడెడ్ MCP సర్వర్ కాన్ఫిగరేషన్](../../../../translated_images/te/chat-mode-agent.729a22473f822216dd1e723aaee1f7d4a2ede571ee0948037a2d9357a63b9d0b.png)
![ఏజెంట్ సెషన్‌కు టూల్ ఎంపిక](../../../../translated_images/te/agent-mode-select-tools.522c7ba5df0848f8f0d1e439c2e96159431bc620cb39ccf3f5dc611412fd0006.png)
![MCP అభివృద్ధి సమయంలో సులభంగా లోపాలను డీబగ్ చేయడం](../../../../translated_images/te/mcp-list-servers.fce89eefe3f30032bed8952e110ab9d82fadf043fcfa071f7d40cf93fb1ea9e9.png)
...
1. *mcp.json* లో మీ ఎంట్రీని కనుగొని "play" ఐకాన్ కనిపిస్తుందో లేదో చూసుకోండి:
  ...
  ![Visual Studio Code లో సర్వర్ ప్రారంభించడం](../../../../translated_images/te/vscode-start-server.8e3c986612e3555de47e5b1e37b2f3020457eeb6a206568570fd74a17e3796ad.png)  
...
1. "play" ఐకాన్‌పై క్లిక్ చేయండి, GitHub Copilot చాట్‌లో టూల్స్ ఐకాన్ అందుబాటులో ఉన్న టూల్స్ సంఖ్య పెరిగినట్లు కనిపిస్తుంది. ఆ టూల్స్ ఐకాన్‌పై క్లిక్ చేస్తే, నమోదు చేసిన టూల్స్ జాబితా కనిపిస్తుంది. మీరు GitHub Copilot వాటిని సందర్భంగా ఉపయోగించాలనుకుంటే ప్రతి టూల్‌ను చెక్/అన్ చెక్ చేయవచ్చు:
  ...
  ![Visual Studio Code లో సర్వర్ ప్రారంభించడం](../../../../translated_images/te/vscode-tool.0b3bbea2fb7d8c26ddf573cad15ef654e55302a323267d8ee6bd742fe7df7fed.png)

1. ఒక టూల్ నడపడానికి, మీ టూల్స్ వివరణకు సరిపోయే ప్రాంప్ట్ టైప్ చేయండి, ఉదాహరణకు "add 22 to 1" వంటి ప్రాంప్ట్:

  ![GitHub Copilot నుండి టూల్ నడపడం](../../../../translated_images/te/vscode-agent.d5a0e0b897331060518fe3f13907677ef52b879db98c64d68a38338608f3751e.png)
