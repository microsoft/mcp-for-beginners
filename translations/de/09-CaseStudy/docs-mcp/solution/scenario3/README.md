...
1. **Füge die MCP-Konfiguration hinzu:**  
   ...
   ![Schritt 1: mcp.json zum .vscode-Ordner hinzufügen](../../../../../../translated_images/de/step1-mcp-json.c06a007fccc3edfa.png)
...
2. **Öffne das GitHub Copilot Chat-Panel:**  
   ...
   ![Schritt 2: Copilot Chat-Panel öffnen](../../../../../../translated_images/de/step2-copilot-panel.f1cc86e9b9b8cd1a.png)

3. **Aktiviere den Agent-Modus und überprüfe die Tools:**  
   Aktiviere im Copilot Chat-Panel den Agent-Modus.  

   ![Schritt 3: Agent-Modus aktivieren und Tools überprüfen](../../../../../../translated_images/de/step3-agent-mode.cdc32520fd7dd1d1.png)
   ...
   ![Schritt 3: MCP-Server-Tool überprüfen](../../../../../../translated_images/de/step3-verify-mcp-tool.76096a6329cbfecd.png)
...
4. **Starte einen neuen Chat und stelle dem Agenten Fragen:**  
   ...
   ![Schritt 4: Agenten im Chat anfragen](../../../../../../translated_images/de/step4-prompt-chat.12187bb001605efc.png)
...
5. **Live-Abfrage:**  
   ...
   *„Ich suche Antworten dazu, wie man eine Multi-Agenten-Lösung mit AI-Agenten, die auf Azure AI Foundry entwickelt wurden, bereitstellt. Es gibt keine direkte Bereitstellungsmethode wie Copilot Studio Channels. Welche verschiedenen Möglichkeiten gibt es, diese Bereitstellung für Unternehmenskunden zu realisieren, damit sie interagieren und ihre Aufgaben erledigen können?  
   ...
   ![Schritt 5: Live-Abfragen](../../../../../../translated_images/de/step5-live-queries.49db3e4a50bea273.png)
