...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T16:56:01+00:00",
...
ลองนึกถึง MCP ว่าเป็นเหมือนตัวแปลภาษาสากลสำหรับแอปพลิเคชัน AI - เหมือนกับพอร์ต USB ที่ช่วยให้คุณเชื่อมต่ออุปกรณ์ใดๆ กับคอมพิวเตอร์ MCP ช่วยให้โมเดล AI เชื่อมต่อกับเครื่องมือหรือบริการใดๆ ได้ในรูปแบบมาตรฐาน ไม่ว่าคุณจะสร้างแชทบอทตัวแรกของคุณหรือทำงานกับเวิร์กโฟลว์ AI ที่ซับซ้อน การเข้าใจ MCP จะช่วยให้คุณสร้างแอปพลิเคชันที่มีความสามารถและยืดหยุ่นมากขึ้น

หลักสูตรนี้ออกแบบมาเพื่อให้คุณเรียนรู้ได้อย่างง่ายดาย เราจะเริ่มต้นด้วยแนวคิดง่ายๆ ที่คุณเข้าใจอยู่แล้ว และค่อยๆ สร้างความเชี่ยวชาญของคุณผ่านการฝึกฝนในภาษาการเขียนโปรแกรมที่คุณชื่นชอบ ทุกขั้นตอนมีคำอธิบายที่ชัดเจน ตัวอย่างที่ใช้งานได้จริง และกำลังใจมากมายตลอดเส้นทาง
...
ทรัพยากรเหล่านี้จะมีคุณค่ามากขึ้นเมื่อคุณเข้าใจมากขึ้น แต่ไม่ต้องกังวลที่จะอ่านทุกอย่างในทันที เริ่มต้นจากส่วนที่คุณสนใจมากที่สุด!  
- 📘 [เอกสาร MCP](https://modelcontextprotocol.io/) – นี่คือแหล่งข้อมูลหลักสำหรับบทเรียนและคู่มือการใช้งานที่มีขั้นตอนชัดเจน เอกสารนี้เขียนขึ้นสำหรับผู้เริ่มต้น โดยมีตัวอย่างที่ชัดเจนที่คุณสามารถทำตามได้ในจังหวะของคุณเอง  
...
- 📜 [สเปค MCP ดั้งเดิม](https://spec.modelcontextprotocol.io/) – มีรายละเอียดทางเทคนิคเพิ่มเติมที่อาจเป็นประโยชน์สำหรับการใช้งานขั้นสูง มันจะอยู่ที่นี่เมื่อคุณต้องการ แต่ไม่ต้องกังวลเมื่อคุณเริ่มต้น  
...
- 🌐 [ชุมชน MCP](https://github.com/orgs/modelcontextprotocol/discussions) – เข้าร่วมกับผู้เรียนและนักพัฒนาที่มีประสบการณ์ในชุมชนที่พูดคุยเกี่ยวกับ MCP เป็นชุมชนที่สนับสนุนซึ่งยินดีต้อนรับคำถามและแบ่งปันความรู้กันอย่างอิสระ  
...
• **นำแนวปฏิบัติด้านความปลอดภัยมาใช้**: คุณจะเข้าใจวิธีรักษาความปลอดภัยในการใช้งาน MCP ของคุณ ปกป้องทั้งแอปพลิเคชันและผู้ใช้งานของคุณ  
...
MCP คือโปรโตคอล - ชุดของกฎที่ตกลงกันไว้ซึ่งช่วยให้โมเดล AI และแอปพลิเคชันมี "การสนทนา" ที่มีประสิทธิภาพกับเครื่องมือและบริการ เช่นเดียวกับการมีกฎการสนทนาที่ทำให้การสื่อสารของมนุษย์ราบรื่น การมี MCP ทำให้การสื่อสารของแอปพลิเคชัน AI มีความน่าเชื่อถือและทรงพลังมากขึ้น

### ความสัมพันธ์ระหว่างไคลเอนต์และเซิร์ฟเวอร์ (วิธีการทำงานร่วมกันของโปรแกรม)

คุณใช้ความสัมพันธ์ระหว่างไคลเอนต์และเซิร์ฟเวอร์ทุกวัน! เมื่อคุณใช้เว็บเบราว์เซอร์ (ไคลเอนต์) เพื่อเยี่ยมชมเว็บไซต์ คุณกำลังเชื่อมต่อกับเว็บเซิร์ฟเวอร์ที่ส่งเนื้อหาของหน้าเว็บให้คุณ เบราว์เซอร์รู้วิธีขอข้อมูล และเซิร์ฟเวอร์รู้วิธีตอบกลับ

ใน MCP เรามีความสัมพันธ์ที่คล้ายกัน: โมเดล AI ทำหน้าที่เป็นไคลเอนต์ที่ร้องขอข้อมูลหรือการดำเนินการ ในขณะที่เซิร์ฟเวอร์ MCP ให้ความสามารถเหล่านั้น เป็นเหมือนการมีผู้ช่วยที่มีประโยชน์ (เซิร์ฟเวอร์) ที่ AI สามารถขอให้ทำงานเฉพาะได้

### ทำไมมาตรฐานถึงสำคัญ (ทำให้สิ่งต่างๆ ทำงานร่วมกัน)

ลองจินตนาการว่าผู้ผลิตรถยนต์แต่ละรายใช้ปั๊มน้ำมันที่มีรูปร่างต่างกัน - คุณจะต้องมีอะแดปเตอร์ที่แตกต่างกันสำหรับรถแต่ละคัน! มาตรฐานหมายถึงการตกลงในวิธีการทั่วไปเพื่อให้สิ่งต่างๆ ทำงานร่วมกันได้อย่างราบรื่น

MCP ให้มาตรฐานนี้สำหรับแอปพลิเคชัน AI แทนที่โมเดล AI แต่ละตัวจะต้องมีโค้ดเฉพาะเพื่อทำงานกับเครื่องมือแต่ละตัว MCP สร้างวิธีการสากลสำหรับการสื่อสาร สิ่งนี้หมายความว่านักพัฒนาสามารถสร้างเครื่องมือครั้งเดียวและให้มันทำงานกับระบบ AI ต่างๆ ได้มากมาย

## 🧭 ภาพรวมเส้นทางการเรียนรู้ของคุณ

การเดินทางในโลก MCP ของคุณถูกออกแบบมาอย่างรอบคอบเพื่อสร้างความมั่นใจและทักษะของคุณอย่างต่อเนื่อง แต่ละขั้นตอนจะแนะนำแนวคิดใหม่ในขณะที่เสริมสิ่งที่คุณได้เรียนรู้ไปแล้ว

### 🌱 ระยะพื้นฐาน: ทำความเข้าใจเบื้องต้น (โมดูล 0-2)

นี่คือจุดเริ่มต้นของการผจญภัยของคุณ! เราจะแนะนำแนวคิดของ MCP โดยใช้การเปรียบเทียบที่คุ้นเคยและตัวอย่างง่ายๆ คุณจะเข้าใจว่า MCP คืออะไร ทำไมมันถึงมีอยู่ และมันเข้ากับโลกของการพัฒนา AI อย่างไร
...
• **โมดูล 2 - ความปลอดภัยใน MCP**: ความปลอดภัยอาจฟังดูน่ากลัว แต่เราจะแสดงให้คุณเห็นว่า MCP มีฟีเจอร์ความปลอดภัยในตัว และสอนแนวปฏิบัติที่ดีที่สุดที่ปกป้องแอปพลิเคชันของคุณตั้งแต่เริ่มต้น  

### 🔨 ระยะสร้าง: สร้างการใช้งานครั้งแรกของคุณ (โมดูล 3)

ตอนนี้ความสนุกที่แท้จริงเริ่มต้นขึ้น! คุณจะได้ประสบการณ์จริงในการสร้างเซิร์ฟเวอร์และไคลเอนต์ MCP จริง ไม่ต้องกังวล - เราจะเริ่มต้นอย่างง่ายและแนะนำคุณในทุกขั้นตอน

โมดูลนี้รวมถึงคู่มือการใช้งานที่ให้คุณฝึกฝนในภาษาการเขียนโปรแกรมที่คุณชื่นชอบ คุณจะสร้างเซิร์ฟเวอร์ตัวแรกของคุณ สร้างไคลเอนต์เพื่อเชื่อมต่อกับมัน และแม้กระทั่งผสานรวมกับเครื่องมือพัฒนายอดนิยมอย่าง VS Code

แต่ละคู่มือมีตัวอย่างโค้ดที่สมบูรณ์ เคล็ดลับการแก้ไขปัญหา และคำอธิบายว่าทำไมเราถึงเลือกการออกแบบเฉพาะทาง โดยสิ้นสุดระยะนี้ คุณจะมีการใช้งาน MCP ที่ใช้งานได้จริงที่คุณสามารถภูมิใจได้!

### 🚀 ระยะเติบโต: แนวคิดขั้นสูงและการใช้งานจริง (โมดูล 4-5)

เมื่อคุณเชี่ยวชาญพื้นฐานแล้ว คุณพร้อมที่จะสำรวจฟีเจอร์ MCP ที่ซับซ้อนมากขึ้น เราจะครอบคลุมกลยุทธ์การใช้งานจริง เทคนิคการแก้ไขข้อบกพร่อง และหัวข้อขั้นสูง เช่น การผสานรวม AI แบบหลายรูปแบบ

คุณยังจะได้เรียนรู้วิธีปรับขนาดการใช้งาน MCP ของคุณสำหรับการใช้งานจริง และผสานรวมกับแพลตฟอร์มคลาวด์อย่าง Azure โมดูลเหล่านี้เตรียมคุณให้สร้างโซลูชั่น MCP ที่สามารถรองรับความต้องการในโลกจริง

### 🌟 ระยะเชี่ยวชาญ: ชุมชนและความเชี่ยวชาญเฉพาะทาง (โมดูล 6-11)
ขั้นตอนสุดท้ายมุ่งเน้นไปที่การเข้าร่วมชุมชน MCP และการเชี่ยวชาญในด้านที่คุณสนใจมากที่สุด คุณจะได้เรียนรู้วิธีการมีส่วนร่วมในโครงการ MCP แบบโอเพ่นซอร์ส การนำรูปแบบการยืนยันตัวตนขั้นสูงไปใช้ และการสร้างโซลูชันที่รวมฐานข้อมูลอย่างครบวงจร

โมดูล 11 สมควรได้รับการกล่าวถึงเป็นพิเศษ - เป็นเส้นทางการเรียนรู้แบบลงมือทำที่มีทั้งหมด 13 ห้องปฏิบัติการ ซึ่งสอนคุณให้สร้างเซิร์ฟเวอร์ MCP ที่พร้อมใช้งานจริงพร้อมการรวม PostgreSQL มันเหมือนกับโครงการสรุปที่รวบรวมทุกสิ่งที่คุณได้เรียนรู้!

### 📚 โครงสร้างหลักสูตรแบบครบวงจร
...
| 3.10 | การใช้งานเซิร์ฟเวอร์ขั้นสูง | ใช้เซิร์ฟเวอร์ขั้นสูงเพื่อการใช้งานฟีเจอร์ขั้นสูงและสถาปัตยกรรมที่ดีขึ้น | [คู่มือ](./03-GettingStarted/10-advanced/README.md) |
...
| 11.1 | บทนำ | ภาพรวมของ MCP พร้อมการรวมฐานข้อมูลและกรณีการวิเคราะห์การค้าปลีก | [Lab 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | ความปลอดภัยและการใช้งานหลายผู้ใช้ | Row Level Security, การยืนยันตัวตน และการเข้าถึงข้อมูลหลายผู้ใช้ | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.9 | การทดสอบและดีบัก | กลยุทธ์การทดสอบ เครื่องมือดีบัก และวิธีการตรวจสอบ | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
...
| 11.13 | แนวทางปฏิบัติที่ดีที่สุด | การปรับปรุงประสิทธิภาพ การเสริมความปลอดภัย และเคล็ดลับการใช้งานจริง | [Lab 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |

### 💻 โครงการตัวอย่างโค้ด

หนึ่งในส่วนที่น่าตื่นเต้นที่สุดของการเรียนรู้ MCP คือการเห็นทักษะการเขียนโค้ดของคุณพัฒนาขึ้นอย่างต่อเนื่อง เราออกแบบตัวอย่างโค้ดของเราให้เริ่มต้นง่ายและซับซ้อนขึ้นเมื่อความเข้าใจของคุณลึกซึ้งขึ้น นี่คือวิธีที่เราแนะนำแนวคิด - ด้วยโค้ดที่เข้าใจง่ายแต่แสดงให้เห็นถึงหลักการของ MCP จริง คุณจะเข้าใจไม่เพียงแค่ว่าโค้ดนี้ทำอะไร แต่ทำไมมันถึงมีโครงสร้างแบบนี้ และมันเข้ากับแอปพลิเคชัน MCP ขนาดใหญ่ได้อย่างไร
...
ที่เก็บนี้รวมถึงทรัพยากรหลายอย่างเพื่อช่วยให้คุณนำทางและเรียนรู้ได้อย่างมีประสิทธิภาพ:

### คู่มือการศึกษา

[คู่มือการศึกษา](./study_guide.md) ที่ครอบคลุมมีให้เพื่อช่วยให้คุณนำทางที่เก็บนี้ได้อย่างมีประสิทธิภาพ แผนที่หลักสูตรแบบภาพนี้แสดงให้เห็นว่าหัวข้อทั้งหมดเชื่อมโยงกันอย่างไร และให้คำแนะนำเกี่ยวกับวิธีการใช้โครงการตัวอย่างอย่างมีประสิทธิภาพ มันมีประโยชน์อย่างยิ่งหากคุณเป็นผู้เรียนที่ชอบเห็นภาพรวม
...
เรารักษา [บันทึกการเปลี่ยนแปลง](./changelog.md) ที่ละเอียดซึ่งติดตามการอัปเดตที่สำคัญทั้งหมดในวัสดุหลักสูตร เพื่อให้คุณทันสมัยกับการปรับปรุงและการเพิ่มเติมล่าสุด
- การเพิ่มเนื้อหาใหม่
...
เน้นการเพิ่มพลังให้กับนักพัฒนาในการใช้ MCP ในกระบวนการทำงานของนักพัฒนา และเฉลิมฉลองชุมชน MCP ที่ยอดเยี่ยม เราจะมีสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta และ Neon มาร่วมแบ่งปันวิธีที่พวกเขาร่วมมือกับ Microsoft เพื่อสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้  
เดโมจากโลกจริงใน VS Code, Visual Studio, GitHub Copilot และเครื่องมือชุมชนยอดนิยม  
...
สำหรับผู้สร้าง MCP เราจะเจาะลึกกลยุทธ์การดำเนินการและแนวปฏิบัติที่ดีที่สุดในการสร้าง MCP servers และการผสาน MCP เข้ากับกระบวนการทำงาน AI ของคุณ
...
เรียนรู้ผ่านวิดีโอเซสชันเข้มข้นเกี่ยวกับวิธีสร้าง MCP servers, ผสานเข้ากับ VS Code และการปรับใช้อย่างมืออาชีพบน Azure โดยอิงจากเนื้อหาหลักสูตร MCP สำหรับผู้เริ่มต้น ออกไปพร้อมกับทักษะที่ใช้งานได้จริงในเทคโนโลยีที่บริษัทใหญ่ๆ กำลังใช้อยู่
...
มาเรียนรู้เกี่ยวกับ Model Context Protocol (MCP) ซึ่งเป็นกรอบงานล้ำสมัยที่ออกแบบมาเพื่อมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันของลูกค้า ผ่านเซสชันที่เหมาะสำหรับผู้เริ่มต้น เราจะนำคุณเข้าสู่ MCP และแนะนำวิธีสร้าง MCP server แรกของคุณ  
#### C#: [https://aka.ms/letslearnmcp-csharp](https://aka.ms/letslearnmcp-csharp)  
#### Java: [https://aka.ms/letslearnmcp-java](https://aka.ms/letslearnmcp-java)  
#### JavaScript: [https://aka.ms/letslearnmcp-javascript](https://aka.ms/letslearnmcp-javascript)  
#### Python: [https://aka.ms/letslearnmcp-python](https://aka.ms/letslearnmcp-python)  

## 🎓 การเดินทางของคุณกับ MCP เริ่มต้นขึ้นแล้ว  

ขอแสดงความยินดี! คุณได้เริ่มต้นการเดินทางที่น่าตื่นเต้นที่จะขยายความสามารถในการเขียนโปรแกรมของคุณและเชื่อมต่อคุณกับการพัฒนา AI ที่ล้ำสมัย  

### สิ่งที่คุณได้ทำสำเร็จแล้ว  

ด้วยการอ่านบทนำนี้ คุณได้เริ่มสร้างพื้นฐานความรู้เกี่ยวกับ MCP แล้ว คุณเข้าใจว่า MCP คืออะไร ทำไมมันถึงสำคัญ และหลักสูตรนี้จะสนับสนุนการเรียนรู้ของคุณอย่างไร นี่เป็นความสำเร็จที่สำคัญและเป็นจุดเริ่มต้นของความเชี่ยวชาญในเทคโนโลยีสำคัญนี้  

### การผจญภัยที่รออยู่  

เมื่อคุณก้าวหน้าผ่านโมดูลต่างๆ จำไว้ว่าผู้เชี่ยวชาญทุกคนเคยเป็นมือใหม่มาก่อน แนวคิดที่อาจดูซับซ้อนในตอนนี้จะกลายเป็นเรื่องธรรมดาเมื่อคุณฝึกฝนและนำไปใช้ แต่ละก้าวเล็กๆ จะนำไปสู่ความสามารถที่ทรงพลังซึ่งจะเป็นประโยชน์ต่อคุณตลอดอาชีพการพัฒนา  

### เครือข่ายสนับสนุนของคุณ  

คุณกำลังเข้าร่วมชุมชนของผู้เรียนและผู้เชี่ยวชาญที่หลงใหลใน MCP และกระตือรือร้นที่จะช่วยให้ผู้อื่นประสบความสำเร็จ ไม่ว่าคุณจะติดปัญหาในความท้าทายการเขียนโค้ดหรืออยากแบ่งปันความสำเร็จ ชุมชนนี้พร้อมสนับสนุนการเดินทางของคุณ  

หากคุณติดปัญหาหรือมีคำถามเกี่ยวกับการสร้างแอป AI เข้าร่วมการสนทนากับผู้เรียนและนักพัฒนาที่มีประสบการณ์เกี่ยวกับ MCP นี่คือชุมชนที่สนับสนุนซึ่งยินดีต้อนรับคำถามและแบ่งปันความรู้อย่างอิสระ  
...
การผจญภัย MCP ของคุณเริ่มต้นขึ้นแล้ว! เริ่มต้นด้วย Module 0 เพื่อดำดิ่งสู่ประสบการณ์ MCP ครั้งแรกของคุณ หรือสำรวจโปรเจกต์ตัวอย่างเพื่อดูสิ่งที่คุณจะสร้าง จำไว้ว่า - ผู้เชี่ยวชาญทุกคนเริ่มต้นจากจุดเดียวกับคุณ และด้วยความอดทนและการฝึกฝน คุณจะประหลาดใจกับสิ่งที่คุณสามารถทำได้  

ยินดีต้อนรับสู่โลกของการพัฒนา Model Context Protocol มาสร้างสิ่งที่น่าทึ่งไปด้วยกัน!

## 🤝 การมีส่วนร่วมในชุมชนการเรียนรู้  

หลักสูตรนี้จะเติบโตแข็งแกร่งขึ้นด้วยการมีส่วนร่วมจากผู้เรียนเช่นคุณ! ไม่ว่าคุณจะช่วยแก้ไขคำผิด เสนอคำอธิบายที่ชัดเจนขึ้น หรือเพิ่มตัวอย่างใหม่ การมีส่วนร่วมของคุณช่วยให้ผู้เริ่มต้นคนอื่นๆ ประสบความสำเร็จ  

ขอบคุณ Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) สำหรับการมีส่วนร่วมในตัวอย่างโค้ด  

กระบวนการการมีส่วนร่วมถูกออกแบบมาให้เป็นมิตรและสนับสนุน การมีส่วนร่วมส่วนใหญ่ต้องการ Contributor License Agreement (CLA) แต่เครื่องมืออัตโนมัติจะนำทางคุณผ่านกระบวนการได้อย่างราบรื่น  
...
โปรเจกต์นี้ยินดีต้อนรับการมีส่วนร่วมและข้อเสนอแนะ การมีส่วนร่วมส่วนใหญ่ต้องการให้คุณตกลงกับ Contributor License Agreement (CLA) โดยประกาศว่าคุณมีสิทธิ์และจริงๆ แล้วให้สิทธิ์เราใช้การมีส่วนร่วมของคุณ สำหรับรายละเอียดเพิ่มเติม โปรดเยี่ยมชม <https://cla.opensource.microsoft.com>  
...
โปรเจกต์นี้ได้นำ [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/) มาใช้ สำหรับข้อมูลเพิ่มเติม โปรดดู [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) หรือ  
ติดต่อ [opencode@microsoft.com](mailto:opencode@microsoft.com) หากมีคำถามหรือความคิดเห็นเพิ่มเติม  

---

*พร้อมเริ่มต้นการเดินทาง MCP ของคุณหรือยัง? เริ่มต้นด้วย [Module 00 - Introduction to MCP](./00-Introduction/README.md) และก้าวแรกของคุณเข้าสู่โลกของการพัฒนา Model Context Protocol!*  
