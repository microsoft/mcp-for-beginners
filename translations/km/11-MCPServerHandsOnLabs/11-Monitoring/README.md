# ការត្រួតពិនិត្យ និងការសង្កេតเห็น

## 🎯 អ្វីដែលមន្ទីរពិសោធន៍នេះគ្របដណ្តប់

មន្ទីរពិសោធន៍នេះផ្តល់នូវការណែនាំទូលំទូលាយសម្រាប់អនុវត្តការត្រួតពិនិត្យ ការសង្កេតเห็น និងការជូនដំណឹងសម្រាប់ម៉ាស៊ីនមេ MCP របស់អ្នកនៅក្នុងបរិបទផលិតកម្ម។ អ្នកនឹងរៀនបង្កើត Application Insights, បង្កើតផ្ទាំងគ្រប់គ្រងមានន័យ, អនុវត្តការជូនដំណឹងមានប្រសិទ្ធភាព, និងបង្កើតចរន្តការដោះស្រាយបញ្ហាដើម្បីឲ្យមានភាពល្អបំផុតក្នុងការប្រតិបត្តិការ។

## សេចក្ដីសង្ខេប

ការត្រួតពិនិត្យ និងការសង្កេតเห็นដែលមានប្រសិទ្ធិភាពមានសារៈសំខាន់ក្នុងការរក្សាទុកម៉ាស៊ីនមេ MCP ដែលទុកចិត្តបាននៅក្នុងផលិតកម្ម។ មន្ទីរពិសោធន៍នេះគ្របដណ្តប់បាតបែនបីនៃការសង្កេតเห็น — ម៉ែត្រិក, កំណត់ហេតុ និងសម្រង់ — ហើយបង្ហាញអ្នកវិធីសាស្ត្រអនុវត្តការត្រួតពិនិត្យទូលំទូលាយ ដែលអនុញ្ញាតឲ្យចាប់ផ្តើមរកឃើញបញ្ហាមុននិងដោះស្រាយបញ្ហាបានយ៉ាងរហ័ស។

អ្នកនឹងរៀនបម្លែងទិន្នន័យទូទឹកចិត្តដើមទៅជាព័ត៌មានអាចអនុវត្តបាន ដែលជួយឲ្យអ្នកយល់អំពីឥរិយាបថប្រព័ន្ធ បង្កើតប្រសិទ្ធិភាព និងធានាការចេញសេវាឡើងខ្ពស់។

## គោលបំណងការសិក្សា

នៅចុងបញ្ចប់នៃមន្ទីរពិសោធន៍នេះ អ្នកនឹងអាច:

- **អនុវត្ត** ការរួមបញ្ចូល Application Insights ទូលំទូលាយសម្រាប់ម៉ាស៊ីនមែ MCP  
- **រៀបចំ** គំរូ កំណត់ហេតុដែលមានរចនាសម្ព័ន្ធសម្រាប់ការដោះស្រាយបញ្ហាបានមានប្រសិទ្ធភាព  
- **បង្កើត** ប្រព័ន្ធប្រមូលនិងវិភាគម៉ែត្រិកសមត្ថភាព  
- **កំណត់រចនាសម្ព័ន្ធ** ការជូនដំណឹងវ័យឆ្លាតជាមួយការជូនដំណឹងអាចអនុវត្តបាន  
- **សាងសង់** ផ្ទាំងគ្រប់គ្រងសម្រាប់ការត្រួតពិនិត្យពេលពិត  
- **បង្កើត** ចរន្តការដោះស្រាយបញ្ហានិងសៀវភៅប្រតិបត្តិការដែលមានប្រសិទ្ធភាព  

## 📊 ការរួមបញ្ចូល Application Insights

### ការដំឡើង Application Insights
...
class MCPTelemetryManager:
    ...
    def initialize_telemetry(self, app):
        ...
        # កំណត់រចនាសម្ព័ន្ធ Azure Monitor
        ...
        # ទទួលបាន tracer និង meter
        self.tracer = trace.get_tracer(__name__)
        self.meter = metrics.get_meter(__name__)
        
        # ចាប់ផ្តើមគំនិតផ្ទាល់ខ្លួន metrics
        self._setup_custom_metrics()
        
        # ប្រើប្រាស់ FastAPI
        FastAPIInstrumentor.instrument_app(app)
        
        # ប្រើប្រាស់ មូលដ្ឋានទិន្នន័យ
...
class StructuredFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        # រចនាសម្ព័ន្ធកំណត់ត្រាផ្ទាល់មូលដ្ឋាន
        log_entry = {
        ...
        # បន្ថែមលក្ខណៈផ្ទាល់ខ្លួនពី extra
        if hasattr(record, 'extra_data'):
            log_entry.update(record.extra_data)
        
        # បន្ថែមអត្តសញ្ញាណការតភ្ជាប់បើមាន
        if hasattr(record, 'correlation_id'):
            log_entry["correlation_id"] = record.correlation_id
        
        # បន្ថែមបរិបទអ្នកប្រើបើមាន
...
class MCPLogger:
    ...
    def _setup_structured_logging(self):
        ...
        # លុបអ្នកដំណើរការដែលមានស្រាប់
        for handler in self.logger.handlers[:]:
            self.logger.removeHandler(handler)
        
        # បង្កើតអ្នកដំណើរការផ្ទៃក្នុងរចនាសម្ព័ន្ធ
...
# ឯកសារវាយតម្លៃទូទៅជាសកល
mcp_logger = MCPLogger("mcp_server")
```

### ការប្រមូលម៉ែត្រិកផ្ទាល់ខ្លួន
...
class MetricsCollector:
    ...
    async def _analyze_query_patterns(self) -> Dict[str, int]:
        ...
        # នេះនឹងវិភាគកំណត់ហេតុស្នើសុំពិតប្រាកដ
        # សម្រាប់គោលបំណងបង្ហាញ ជាការត្រលប់ទៅទិន្នន័យគំរូ
        return {
            "sales_analysis": 45,
            "inventory_check": 23,
            "customer_lookup": 18,
    ...
    async def _analyze_user_activity(self) -> Dict[str, int]:
        ...
        # នេះនឹងវិភាគកំណត់ហេតុសកម្មភាពអ្នកប្រើពិតប្រាកដ
        return {
            "seattle": 67,
            "redmond": 34,
            "bellevue": 23,
...
# អ្នកប្រមូលគ្រប់គ្រងលំនាំទូទៅ
metrics_collector = MetricsCollector()
```

## 🔔 ការកំណត់ការជូនដំណឹង

### ប្រព័ន្ធការជូនដំណឹងវ័យឆ្លាត
...
class AlertManager:
    ...
    def _setup_default_rules(self):
        ...
        self.add_alert_rule(AlertRule(
            ...
            condition=lambda metrics: metrics.get("error_rate", 0) > 0.05,  # អត្រាខុស ៥%
            severity=AlertSeverity.HIGH,
            cooldown_minutes=10,
            message_template="High error rate detected: {error_rate:.2%}. Investigate immediately."
        ))
        
        # ប្រសិទ្ធភាពស្នើសុំយឺត
        self.add_alert_rule(AlertRule(
            name="slow_query_performance",
            condition=lambda metrics: metrics.get("avg_query_duration", 0) > 2.0,  # ២ វិនាទី
            severity=AlertSeverity.MEDIUM,
            cooldown_minutes=15,
            message_template="Slow query performance detected. Average duration: {avg_query_duration:.2f}s"
        ))
        
        # ការប្រើប្រាស់ CPU ខ្ពស់
        self.add_alert_rule(AlertRule(
            name="high_cpu_usage",
            condition=lambda metrics: metrics.get("cpu_usage", 0) > 85,  # CPU ៨៥%
            severity=AlertSeverity.MEDIUM,
            cooldown_minutes=10,
        ...
        self.add_alert_rule(AlertRule(
            ...
            condition=lambda metrics: metrics.get("memory_usage_percent", 0) > 90,  # អង្គចងចាំ ៩០%
            severity=AlertSeverity.HIGH,
            cooldown_minutes=5,
            message_template="High memory usage detected: {memory_usage_percent:.1f}%"
        ))
        
        # ការបរាជ័យផ្ទៀងផ្ទាត់
        self.add_alert_rule(AlertRule(
            name="authentication_failures",
            condition=lambda metrics: metrics.get("auth_failure_rate", 0) > 0.1,  # អត្រាបរាជ័យ ១០%
            severity=AlertSeverity.HIGH,
            cooldown_minutes=5,
    ...
    async def evaluate_metrics(self, metrics: Dict[str, Any]):
        ...
        for rule_name, rule in self.alert_rules.items():
            ...
            try:
                # ពិនិត្យមើលបើលទ្ធផលនៃច្បាប់ត្រូវបានបំពេញ
                if rule.condition(metrics):
                    await self._trigger_alert(rule, metrics)
                else:
                    # បញ្ចប់ការជូនដំណឹងបើលទ្ធផលមិនត្រូវបានបំពេញទេ
    ...
    async def _clear_alert(self, rule_name: str):
        ...
        if rule_name in self.active_alerts:
            ...
            # ផ្ញើការជូនដំណឹងដើម្បីដោះស្រាយសម្រាប់ការជូនដំណឹងខ្ពស់/វិសមភាព
    ...
    async def _send_notifications(self, alert: Alert):
        ...
        if tasks:
            # រង់ចាំការជូនដំណឹងទាំងអស់ជាមួយពេលវេលាកំណត់
            try:
...
class TeamsNotifier:
    ...
    async def send_notification(self, alert: Alert):
        ...
        color_map = {
            AlertSeverity.LOW: "28a745",     # ពណ៌បៃតង
            AlertSeverity.MEDIUM: "ffc107",   # ពណ៌លឿង
            AlertSeverity.HIGH: "fd7e14",     # ពណ៌ទឹកក្រូច
            AlertSeverity.CRITICAL: "dc3545"  # ពណ៌ក្រហម
        }
...
# ម៉ាណេជ័រជូនដំណឹងជាសកល
alert_manager = AlertManager()
```

## 📈 ការបង្កើតផ្ទាំងគ្រប់គ្រង

### សៀវភៅកម្មវិធី Azure Monitor
...
### ការអនុវត្តផ្ទាំងគ្រប់គ្រងផ្ទាល់ខ្លួន
...
class DashboardDataProvider:
    ...
    async def _get_avg_response_time(self, since_time: float) -> float:
        ...
        return summary.get("mean", 0.0) * 1000  # បម្លែងទៅមីលីវិនាទី
    ...
    async def _get_system_health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "status": "healthy"  # នឹងអនុវត្តត្រឹមត្រូវនូវតុល្យភាពសុខភាព
        }

# ការចូលប្រើ API គ្រប់គ្រងផ្ទាំងបង្ហាញ
...
## 🔍 ចរន្តការដោះស្រាយបញ្ហា

### ការវិភាគដោយស្វ័យប្រវត្តិ
...
class DiagnosticResult:
    ...
    check_name: str
    status: str  # "ជាប់", "បរាជ័យ", "ការព្រមាន"
    message: str
    details: Dict[str, Any]
...
class DiagnosticsEngine:
    ...
    async def _check_azure_services(self) -> DiagnosticResult:
        ...
        try:
            ...
            # នេះនឹងអនុវត្តការសាកល្បងការតភ្ជាប់ពិតប្រាកដ
            # សម្រាប់ឥឡូវនេះ គ្រាន់តែពិនិត្យការកំណត់រចនាសម្ព័ន្ធ
    ...
    async def _check_configuration(self) -> DiagnosticResult:
        ...
        try:
            ...
            # ពិនិត្យអថេរបរិស្ថានដែលត្រូវការ
            required_vars = [
            ...
            # ពិនិត្យភាពកំណត់រចនាសម្ព័ន្ធឱ្យស្របគ្នា
...
✅ **ការរួមបញ្ចូល Application Insights**: ការតម្លើងពេញលេញនៃទូទឹកចិត្តនិងការត្រួតពិនិត្យ  
✅ **កំណត់ហេតុមានរចនាសម្ព័ន្ធ**: កំណត់ហេតុដែលប្រើបានសម្រាប់ផលិតកម្មជាមួយការតភ្ជាប់និងបរិបទ  
✅ **ម៉ែត្រិកផ្ទាល់ខ្លួន**: ប្រមូលនិងវិភាគម៉ែត្រិកអាជីវកម្មនិងបច្ចេកទេស  
✅ **ការជូនដំណឹងវ័យឆ្លាត**: ការជូនដំណឹងចាប់ផ្តើមជាមុនជាមួយប៉ុស្តិ៍ជូនដំណឹងច្រើន  
✅ **ផ្ទាំងគ្រប់គ្រងប្រតិបត្តិការ**: ការត្រួតពិនិត្យពេលពិតនិងព័ត៌មានអាជីវកម្ម  
✅ **ចរន្តការដោះស្រាយបញ្ហា**: ការវិភាគដែលស្វ័យប្រវត្តិនិងសៀវភៅប្រតិបត្តិការ  

## 🚀 តើខាងមុខមានអ្វី

បន្តជាមួយ **[មន្ទីរពិសោធន៍ 12: អនុវត្តវិធីសាស្ត្រល្អបំផុតនិងការបង្កើនប្រសិទ្ធភាព](../12-Best-Practices/README.md)** ដើម្បី:

- អនុវត្តវិធីសាស្ត្របង្កើនសមត្ថភាពនានា  
- អនុវត្តការពារ​សុវត្ថិភាព​ឲ្យគ្រប់គ្រាន់  
- រៀនអំពីការដាក់ឲ្យដំណើរការផលិតកម្មល្អបំផុត  
- បង្កើតយុទ្ធសាស្ត្រការ​ប្រើប្រាស់ថវិកាបានមានប្រសិទ្ធភាព  

## 📚 កម្មវិធីសិក្សាបន្ថែម

### Azure Monitor
- [ឯកសារ Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - មគ្គុទេសក៍ត្រួតពិនិត្យពេញលេញ  
- [រាយការណ៍សំណួរ KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - ភាសាសំណួរសម្រាប់ Application Insights  
- [សៀវភៅកម្មវិធី Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - ការបង្កើតផ្ទាំងគ្រប់គ្រងផ្ទាល់ខ្លួន  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - មគ្គុទេសក៍ឧបករណ៍  
- [ការតាមដានចែករំលែក](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - គំនិតអំពីការតាមដាន  
- [ការប្រមូលម៉ែត្រិក](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - វិធីសាស្ត្រល្អបំផុតសម្រាប់ម៉ែត្រិក  

### ភាពល្អបំផុតក្នុងប្រតិបត្តិការ
- [សៀវភៅ SRE](https://sre.google/sre-book/table-of-contents/) - គោលការណ៍ដឹកនាំ Site Reliability Engineering  
- [វិធីសាស្ត្រល្អបំផុតសម្រាប់ការត្រួតពិនិត្យ](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - វិធីសាស្ត្រអាជីវកម្ម  
- [ការឆ្លើយតបព្រឹត្តិការណ៍](https://response.pagerduty.com/) - មគ្គុទេសក៍គ្រប់គ្រងព្រឹត្តិការណ៍  

---

**មុន**: [មន្ទីរពិសោធន៍ 10: រចនាសម្ព័ន្ធការដាក់ឲ្យដំណើរការ](../10-Deployment/README.md)  
**បន្ទាប់**: [មន្ទីរពិសោធន៍ 12: អនុវត្តវិធីសាស្ត្រល្អបំផុតនិងការបង្កើនប្រសិទ្ធភាព](../12-Best-Practices/README.md)

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**ការបដិសេធ**៖  
ឯកសារនេះត្រូវបានបំលែងភាសាតាមប្រព័ន្ធបកប្រែ AI [Co-op Translator](https://github.com/Azure/co-op-translator)។ ក្នុងខណៈដែលយើងខិតខំប្រឹងប្រែងដើម្បីភាពត្រឹមត្រូវ សូមគោរពថាការបកប្រែដោយម៉ាស៊ីនដោយស្វ័យប្រវត្តិនេះអាចមានកំហុស ឬភាពមិនត្រឹមត្រូវ។ ឯកសារដំបូងទាំងមូលជាភាសាដើមគួរត្រូវបានគិតថាជា ប្រភពផ្លូវការជាចម្បង។ សម្រាប់ព័ត៌មានសំខាន់ៗ អនុសាសន៍ឲ្យមានការបកប្រែដោយមនុស្សដែលជាអ្នកជំនាញ។ យើងមិនទទួលខុសត្រូវចំពោះការយល់ច្រឡំនិងការបកប្រែខុសឆ្គងដែលកើតមានពីការប្រើប្រាស់ការបកប្រែនេះឡើយ។
