...
1. **छोटे से शुरू करें**: डॉक्यूमेंटेशन, बग फिक्स, या छोटे सुधारों से शुरुआत करें।
...
1. **प्रोटोकॉल संस्करणिंग**: MCP प्रोटोकॉल संस्करण का पालन करें जिसे आपका टूल समर्थन करता है।
