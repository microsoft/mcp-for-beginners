...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T09:05:18+00:00",
...
- **責任歸屬破壞**：無法識別客戶端，破壞審計軌跡及事件調查  
- **代理基礎資料外洩**：惡意行為者利用伺服器作為代理進行未授權資料存取  
- **信任邊界違反**：破壞下游服務對令牌來源的信任假設  
- **橫向移動**：跨多服務的受損令牌擴大攻擊範圍
...
**調查支援：**  
- **審計軌跡保存**：不可變更且具密碼學完整性的日誌  
- **證據收集**：自動收集相關安全證據  
- **時間線重建**：詳細重建導致安全事件的事件序列  
- **影響評估**：評估妥協範圍及資料暴露
...
> **重要**：這些安全控制反映當前 MCP 規範 (2025-06-18)。標準持續快速演進，請務必參考最新 [官方文件](https://spec.modelcontextprotocol.io/) 以確保合規。
