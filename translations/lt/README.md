...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-21T17:23:15+00:00",
...
Sveiki atvykę į kelionę po Modelio Konteksto Protokolą! Jei kada nors susimąstėte, kaip AI programos bendrauja su įvairiais įrankiais ir paslaugomis, tuoj sužinosite apie elegantišką sprendimą, kuris keičia būdą, kaip kūrėjai kuria intelektualias sistemas.
...
Baigę šią kelionę, turėsite pasitikėjimo kurti savo MCP serverius, integruoti juos su populiariomis AI platformomis ir suprasti, kaip ši technologija keičia AI kūrimo ateitį. Pradėkime šį jaudinantį nuotykį kartu!
...
- 📜 [MCP Specifikacija](https://modelcontextprotocol.io/docs/) – Tai jūsų išsamus informacinis vadovas. Mokymo programos metu dažnai grįšite čia, kad sužinotumėte konkrečias detales ir išnagrinėtumėte pažangias funkcijas.
- 📜 [Originali MCP Specifikacija](https://spec.modelcontextprotocol.io/) – Čia rasite papildomą techninę informaciją, kuri gali būti naudinga pažangiems įgyvendinimams. Ji bus naudinga, kai jums jos prireiks, tačiau pradžioje nesijaudinkite dėl jos.
...
• **Suprasti MCP pagrindus**: Suprasite, kas yra Modelio Konteksto Protokolas ir kodėl jis revoliucionizuoja AI programų bendradarbiavimą, naudojant analogijas ir pavyzdžius, kurie yra aiškūs.
...
Prieš pasinerdami į MCP specifiką, įsitikinkime, kad jaučiatės patogiai su kai kuriomis pagrindinėmis sąvokomis. Nesijaudinkite, jei nesate šių sričių ekspertas – viską paaiškinsime eigoje!
...
MCP suteikia šią standartizaciją AI programoms. Vietoj to, kad kiekvienam AI modeliui reikėtų specialaus kodo, kad veiktų su kiekvienu įrankiu, MCP sukuria universalų būdą jiems bendrauti. Tai reiškia, kad kūrėjai gali kurti įrankius vieną kartą ir jie veiks su daugeliu skirtingų AI sistemų.
...
### 🌱 Pagrindų Faze: Pagrindų Supratimas (Moduliai 0-2)
...
### 🔨 Kūrimo Faze: Pirmųjų Įgyvendinimų Kūrimas (Modulis 3)
...
Šis modulis apima kelis praktinius vadovus, kurie leidžia jums praktikuotis jūsų pasirinkta programavimo kalba. Sukursite savo pirmąjį serverį, sukursite klientą, kuris prie jo prisijungs, ir netgi integruosite su populiariais kūrimo įrankiais, tokiais kaip VS Code.

Kiekviename vadove rasite pilnus kodų pavyzdžius, trikčių šalinimo patarimus ir paaiškinimus, kodėl darome konkrečius dizaino pasirinkimus. Baigę šią fazę, turėsite veikiančius MCP įgyvendinimus, kuriais galėsite didžiuotis!

### 🚀 Augimo Faze: Pažangios Sąvokos ir Realus Pritaikymas (Moduliai 4-5)

Įvaldę pagrindus, esate pasiruošę tyrinėti sudėtingesnes MCP funkcijas. Aptarsime praktines įgyvendinimo strategijas, derinimo technikas ir pažangias temas, tokias kaip multimodalinis AI integravimas.

Taip pat sužinosite, kaip išplėsti savo MCP įgyvendinimus gamybos naudojimui ir integruoti su debesų platformomis, tokiomis kaip Azure. Šie moduliai paruošia jus kurti MCP sprendimus, kurie gali atlaikyti realaus pasaulio poreikius.

### 🌟 Meistriškumo Faze: Bendruomenė ir Specializacija (Moduliai 6-11)
Galutinis etapas orientuotas į prisijungimą prie MCP bendruomenės ir specializaciją srityse, kurios jus labiausiai domina. Jūs išmoksite, kaip prisidėti prie atvirojo kodo MCP projektų, įgyvendinti pažangius autentifikacijos modelius ir kurti išsamius sprendimus, integruotus su duomenų bazėmis.
...
| 00 | Įvadas į MCP | Model Context Protocol apžvalga ir jo svarba AI procesuose | [Plačiau](./00-Introduction/README.md) |
| 01 | Pagrindinės sąvokos | Išsamus pagrindinių MCP sąvokų tyrimas | [Plačiau](./01-CoreConcepts/README.md) |
| 02 | MCP saugumas | Saugumo grėsmės ir geriausios praktikos | [Plačiau](./02-Security/README.md) |
| 03 | Pradžia su MCP | Aplinkos paruošimas, pagrindiniai serveriai/klientai, integracija | [Plačiau](./03-GettingStarted/README.md) |
...
| 04 | Praktinis įgyvendinimas | SDK, derinimas, testavimas, pakartotinai naudojami šablonai | [Plačiau](./04-PracticalImplementation/README.md) |
| 05 | Pažangios MCP temos | Multimodalinis AI, mastelio keitimas, įmonių naudojimas | [Plačiau](./05-AdvancedTopics/README.md) |
...
| 11.3 | Saugumas ir daugiaklientė aplinka | Eilučių lygio saugumas, autentifikacija ir daugiaklientė duomenų prieiga | [Laboratorija 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.10 | VS Code integracija | VS Code MCP integracijos ir AI pokalbių naudojimo konfigūracija | [Laboratorija 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
| 11.12 | Stebėjimas | Application Insights, logų rinkimas, našumo stebėjimas | [Laboratorija 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
...
Viena iš įdomiausių MCP mokymosi dalių yra stebėti, kaip jūsų programavimo įgūdžiai palaipsniui tobulėja. Mūsų kodų pavyzdžiai sukurti taip, kad pradėtų nuo paprastų ir taptų sudėtingesni, kai jūsų supratimas gilėja. Štai kaip mes pristatome koncepcijas – su kodu, kuris lengvai suprantamas, bet demonstruoja tikrus MCP principus. Jūs suprasite ne tik ką šis kodas daro, bet ir kodėl jis struktūrizuotas būtent taip bei kaip jis įsilieja į didesnes MCP programas.
...
Mes palaikome išsamų [Pakeitimų žurnalą](./changelog.md), kuriame sekami visi reikšmingi mokymo medžiagos atnaujinimai, kad galėtumėte būti informuoti apie naujausius patobulinimus ir papildymus.
...
3. Pratimus realių MCP programų kūrimui  
...
Skirta suteikti galimybes kūrėjams naudoti MCP savo kūrimo procese ir švęsti nuostabią MCP bendruomenę. Prie mūsų prisijungs bendruomenės nariai ir partneriai, tokie kaip Arcade, Block, Okta ir Neon, kad parodytų, kaip jie bendradarbiauja su Microsoft, kurdami atvirą ir išplečiamą MCP ekosistemą. 
...
Skirta MCP kūrėjams. Gilinsimės į įgyvendinimo strategijas ir geriausią praktiką kuriant MCP serverius bei integruojant MCP į jūsų AI procesus.
...
Jei esate kūrėjas, įrankių kūrėjas ar AI produktų strategas, ši diena kupina įžvalgų, reikalingų kurti mastelio, saugius ir ateičiai pasiruošusius MCP sprendimus.

### MCP Boot Camp 2025 m. rugpjūtis
Intensyviuose vaizdo sesijose išmokite kurti MCP serverius, integruoti su VS Code ir profesionaliai diegti Azure platformoje, remiantis MCP pradedančiųjų mokymo programa. Įgykite praktinių įgūdžių technologijoje, kurią jau naudoja didelės įmonės.
...
Sveikiname! Jūs ką tik žengėte pirmąjį žingsnį įdomioje kelionėje, kuri praplės jūsų programavimo galimybes ir sujungs jus su pažangia AI kūrimo technologija.
...
Jūs prisijungiate prie mokinių ir ekspertų bendruomenės, kuri yra aistringa MCP ir nori padėti kitiems pasisekti. Nesvarbu, ar susiduriate su kodavimo iššūkiu, ar norite pasidalinti savo atradimu, bendruomenė yra čia, kad palaikytų jūsų kelionę.
...
## 🤝 Prisidėkite prie mokymosi bendruomenės

Ši mokymo programa stiprėja su mokinių, tokių kaip jūs, indėliu! Nesvarbu, ar taisote klaidą, siūlote aiškesnį paaiškinimą, ar pridedate naują pavyzdį, jūsų indėlis padeda kitiems pradedantiesiems pasisekti.
...
Šis projektas sveikina indėlius ir pasiūlymus. Dauguma indėlių reikalauja, kad sutiktumėte su Contributor License Agreement (CLA), deklaruojančiu, kad turite teisę ir iš tikrųjų suteikiate mums teises naudoti jūsų indėlį. Daugiau informacijos rasite <https://cla.opensource.microsoft.com>.
