...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-26T16:25:02+00:00",
...
> **Dabartinis Standartas**: Šis vadovas atitinka [MCP Specifikacijos 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) saugumo reikalavimus ir oficialias [MCP Saugumo Geriausias Praktikas](https://modelcontextprotocol.io/specification/2025-06-18/basic/security_best_practices).

Saugumas yra itin svarbus MCP įgyvendinimams, ypač įmonių aplinkose. Šis pažangus vadovas nagrinėja išsamias saugumo praktikas, skirtas MCP diegimui gamyboje, apimančias tiek tradicinius saugumo klausimus, tiek AI specifines grėsmes, būdingas Model Context Protocol.

## Įvadas

Model Context Protocol (MCP) kelia unikalius saugumo iššūkius, kurie peržengia tradicinės programinės įrangos saugumo ribas. Kadangi AI sistemos gauna prieigą prie įrankių, duomenų ir išorinių paslaugų, atsiranda nauji atakų vektoriai, tokie kaip prompt injekcijos, įrankių užnuodijimas, sesijų užgrobimas, painaus tarpininko problemos ir žetonų perdavimo pažeidžiamumai.

Ši pamoka nagrinėja pažangius saugumo įgyvendinimus, remiantis naujausia MCP specifikacija (2025-06-18), „Microsoft“ saugumo sprendimais ir įmonių saugumo modeliais.

### **Pagrindiniai Saugumo Principai**

**Pagal MCP Specifikaciją (2025-06-18):**

- **Aiškūs Draudimai**: MCP serveriai **NETURI** priimti žetonų, kurie nėra jiems skirti, ir **NETURI** naudoti sesijų autentifikacijai
- **Privalomas Patikrinimas**: Visi gaunami užklausos **PRIVALOMAI** turi būti patikrintos, o vartotojo sutikimas **PRIVALOMAI** gautas už tarpininkavimo operacijas
- **Saugios Numatytosios Nuostatos**: Įgyvendinkite saugumo kontrolę su gynybos sluoksniais
- **Vartotojo Kontrolė**: Vartotojai turi aiškiai sutikti prieš bet kokį duomenų prieigą ar įrankių vykdymą

## Mokymosi Tikslai

Šios pažangios pamokos pabaigoje jūs galėsite:
...
- **Apsaugoti nuo AI Specifinių Atakų**: Apsaugoti nuo prompt injekcijų, įrankių užnuodijimo ir sesijų užgrobimo naudojant „Microsoft Prompt Shields“ ir „Azure Content Safety“
- **Taikyti Įmonių Saugumą**: Įgyvendinti išsamų žurnalų vedimą, stebėjimą ir incidentų valdymą MCP diegimams gamyboje  
- **Užtikrinti Įrankių Vykdymo Saugumą**: Sukurti izoliuotas vykdymo aplinkas su tinkama izoliacija ir išteklių kontrole
- **Spręsti MCP Pažeidžiamumus**: Atpažinti ir sumažinti painaus tarpininko problemas, žetonų perdavimo pažeidžiamumus ir tiekimo grandinės rizikas
- **Integruoti „Microsoft“ Saugumą**: Naudoti „Azure“ saugumo paslaugas ir „GitHub Advanced Security“ visapusiškai apsaugai
...
Šiuolaikiniai MCP įgyvendinimai pasinaudoja specifikacijos evoliucija link išorinių tapatybės tiekėjų delegavimo, žymiai pagerindami saugumo lygį, palyginti su individualiais autentifikavimo sprendimais.

### **Microsoft Entra ID Integracija**

Dabartinė MCP specifikacija (2025-06-18) leidžia deleguoti išoriniams tapatybės tiekėjams, tokiems kaip „Microsoft Entra ID“, suteikiant įmonės lygio saugumo funkcijas:

**Saugumo Privalumai:**
- Įmonės lygio daugiafaktorinis autentifikavimas (MFA)
...
Patobulintas įgyvendinimas, naudojant „Microsoft“ saugumo ekosistemą:
...
Patobulintas „Spring Security“ įgyvendinimas, atitinkantis OAuth 2.1 saugumo modelius, reikalaujamus MCP specifikacijoje:
...
### **Prompt Injekcijų Apsauga su „Microsoft Prompt Shields“**
...
### **1. Painaus Tarpininko Atakų Prevencija**
...
Autentifikavimas ir Autorizacija:
  ...
  Žetonų auditorijos patvirtinimas (PRIVALOMA)
  Nėra sesijomis pagrįsto autentifikavimo
...
Sesijų Saugumas:
  ...
  Vartotojui specifinis sesijų susiejimas
  Sesijų užgrobimo aptikimas
  HTTPS transporto užtikrinimas
  
OAuth ir Tarpininkavimo Saugumas:
  PKCE įgyvendinimas (OAuth 2.1)
  Aiškus vartotojo sutikimas dinaminėms klientų užklausoms
  Griežtas peradresavimo URI patvirtinimas
  Nėra žetonų perdavimo (PRIVALOMA)
...
- **Integruota Saugumo Pozicija**: Vieninga sauga tapatybėms, infrastruktūrai ir programoms
- **Pažangi AI Apsauga**: Specialiai sukurtos apsaugos nuo AI specifinių grėsmių  
- **Įmonių Atitiktis**: Įmontuota parama reguliavimo reikalavimams ir pramonės standartams
- **Grėsmių Žvalgyba**: Pasaulinės grėsmių žvalgybos integracija proaktyviai apsaugai
- **Mastelio Architektūra**: Įmonių lygio mastelio didinimas su išlaikytomis saugumo kontrolėmis
...
> **Saugumo Pranešimas**: Šis pažangus įgyvendinimo vadovas atspindi dabartinius MCP specifikacijos (2025-06-18) reikalavimus. Visada tikrinkite pagal naujausią oficialią dokumentaciją ir atsižvelkite į savo specifinius saugumo reikalavimus bei grėsmių modelį, įgyvendindami šias kontrolės priemones.
