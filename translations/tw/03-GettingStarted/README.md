...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-06T22:21:59+00:00",
...
[![建立您的第一個 MCP 伺服器](../../../translated_images/zh-TW/04.0ea920069efd979a0b2dad51e72c1df7ead9c57b3305796068a6cee1f0dd6674.png)](https://youtu.be/sNDZO9N4m9Y)
...
- **3 使用 LLM 的客戶端**，更好的方式是為客戶端添加 LLM，使其能夠與伺服器「協商」該執行什麼操作，[前往課程](03-llm-client/README.md)
...
- **7 在 VSCode 中使用 AI 工具包**，以消耗和測試您的 MCP 客戶端和伺服器，[前往課程](07-aitk/README.md)

- **8 測試**，本課程將特別關注如何以不同方式測試伺服器和客戶端，[前往課程](08-testing/README.md)
