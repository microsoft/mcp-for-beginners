...
- **14 Sampling**. Learn how MCP clients and servers can collaborate using sampling to delegate LLM features to the client, [to the lesson](./14-sampling/README.md)

- **15 MCP Apps**. Build and integrate MCP-powered applications, [to the lesson](./15-mcp-apps/README.md)
